...
<div class="col-md-12 inner player-position-cb">
    <h4>player stats as CB</h4>

    <table class="player-score player-score-cb">
        <tr>
           <th>
            <img src="<?php echo get_template_directory_uri(); ?>/img/logo.png">
                ...
                if( have_rows('player_cornerback') ):
                  // loop through the rows of data
                    while ( have_rows('player_cornerback') ) : the_row();?>
            <th>
