    ...
    <div class="container results">
     <div class="row">
          ...
          <?php if( have_rows('calendar_a') ): while ( have_rows('calendar_a') ) : the_row();?>
           <div class="game-bar">
            <div class="col-md-5 team-game result-left-team">
             <?php $posts = get_sub_field('home_team'); if( $posts ): ?>
              <?php foreach( $posts as $p ):?>
               <span><?php echo get_the_title($p->ID); ?></span>
                <?php endforeach; endif; ?>
                 <?php $posts = get_sub_field('home_team'); if( $posts ): foreach( $posts as $p ):?>
            ...
            <div class="col-md-5 team-game">
             ...
             <img class="result-pic" src="<?php echo wp_get_attachment_url( get_post_thumbnail_id( $p->ID ) ); ?>" alt="">
              <?php endforeach; endif; ?>                <?php $posts = get_sub_field('away_team'); if( $posts ): ?>
              <?php foreach( $posts as $p ):?>
              <span><?php echo get_the_title($p->ID); ?></span>
              <?php endforeach; endif; ?>
            </div>
             ...
             <div class="game-bar">
              <div class="col-md-5 team-game result-left-team">
               ...
               <div class="col-md-5 team-game">
                  ...
                  <img class="result-pic" src="<?php echo wp_get_attachment_url(get_post_thumbnail_id( $p->ID ) ); ?>" alt="">
                  <?php endforeach; endif; ?>
                  <?php $posts = get_sub_field('away_team'); if( $posts ): ?>
                  <?php foreach( $posts as $p ):?>
                  <span><?php echo get_the_title($p->ID); ?></span>
                  <?php endforeach; endif; ?>
      ...
      <div class="col-md-12">
          ...
          <?php if( have_rows('calendar_c') ): while ( have_rows('calendar_c') ) : the_row();?>
            <div class="game-bar">
              <div class="col-md-5 team-game result-left-team">
                <?php $posts = get_sub_field('home_team'); if( $posts ): ?>
                <?php foreach( $posts as $p ): ?>
