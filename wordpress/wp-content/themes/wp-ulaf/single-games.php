...
<section class="container container-content-game">
  <div class="row single-game">
    ...
    <div class="col-md-12 team-single-game">
      <div class="col-md-4">
        <?php  $posts = get_field('first_home_team'); if( $posts ): foreach( $posts as $p ): ?>
      ...
      <div class="col-md-4">
       ...
       <div class="single-game-score">
         <span><?php the_field('score_first_team');?></span> :
         <span><?php the_field('score_second_team');?></span>
        ...
        <div class="col-md-4">
          <?php  $posts = get_field('opposing_team');  if( $posts ): foreach( $posts as $p ): ?>
          <img src="<?php echo wp_get_attachment_url( get_post_thumbnail_id( $p->ID ) ); ?>" alt="">
          <?php endforeach; ?>
          <?php endif; ?>
          <?php wp_reset_query(); ?>
    ...
    <table class="team-game-score">
      ...
      <tr>
        ...
        <?php if( have_rows('first_team_game') ): while ( have_rows('first_team_game') ) : the_row();?>
        <td class="gold-score">
      ...
      <tr>
        <td class="gold-score"><?php  $posts = get_field('opposing_team');  if( $posts ): foreach( $posts as $p ): ?>
          <?php echo get_the_title( $p->ID ); ?>
          <?php endforeach; ?>
          <?php endif; ?>
        </td>
        <?php if( have_rows('second_team') ): while ( have_rows('second_team') ) : the_row();?>
        <td class="gold-score">
        <?php the_sub_field('1st_quarter'); ?>
        </td>
        <td class="gold-score"><?php the_sub_field('2nd_quarter'); ?></td>
    ...
    <div class="total-yds col-md-12">
     <div class="home-team-total-yds col-md-9">
      ...
      <?php if( have_rows('point_scorer') ):  while ( have_rows('point_scorer') ) : the_row();?>
    ...
    <div class="away-team-total-yds col-md-3">
        ...
        <div>Результативные действия:</div>
      <div class="score-authors">
        <?php if( have_rows('point_scorer_away') ):
        ...
        <span class="score-player-name">
        <?php $posts = get_sub_field('score_author_away'); if( $posts ): ?>
