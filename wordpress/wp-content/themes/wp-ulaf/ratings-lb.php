<?php /* Template Name: Ratings LB */ get_header(); ?>
...
// check if the repeater field has rows of data
                  if( have_rows('lb_ratings_b') ):

  // loop through the rows of data
                  while ( have_rows('lb_ratings_b') ) : the_row();?>
...
// check if the repeater field has rows of data
                  if( have_rows('lb_ratings_c') ):

  // loop through the rows of data
                  while ( have_rows('lb_ratings_c') ) : the_row();?>
