...
namespace f12_profiler\includes {
	...
	class FilterWrapper {
		...
		public function wrapper( ...$args ) {
			...
			$debug_stack = debug_backtrace( DEBUG_BACKTRACE_IGNORE_ARGS | DEBUG_BACKTRACE_PROVIDE_OBJECT ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_debug_backtrace -- Used only for debugging purposes as a development tool.
