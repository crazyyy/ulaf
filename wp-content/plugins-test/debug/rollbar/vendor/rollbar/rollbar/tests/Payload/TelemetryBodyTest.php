...
class TelemetryBodyTest extends BaseRollbarTest
{
    ...
    {
        $body = new TelemetryBody(message: 'message', method: 'method', url: 'url', status_code: 'status', subtype: 'sub', stack: 'stack', from: 'from', to: 'to', start_timestamp_ms: 42, end_timestamp_ms: 43, extraOne: 'foo', extraTwo: 'bar');
        ...
        self::assertSame(['extraOne' => 'foo', 'extraTwo' => 'bar'], $body->extra);
        // Assert array order does not matter.
        $body = new TelemetryBody(...['message' => 'message', 'extraOne' => 'foo', 'stack' => 'stack']);
        self::assertSame('message', $body->message);
    ...
    {
        $body = new TelemetryBody(message: 'message', method: 'method', url: 'url', status_code: 'status', subtype: 'sub', stack: 'stack', from: 'from', to: 'to', start_timestamp_ms: 42, end_timestamp_ms: 43, extraOne: 'foo', extraTwo: 'bar');
        self::assertSame(['message' => 'message', 'method' => 'method', 'url' => 'url', 'status_code' => 'status', 'subtype' => 'sub', 'stack' => 'stack', 'from' => 'from', 'to' => 'to', 'start_timestamp_ms' => 42, 'end_timestamp_ms' => 43, 'extraOne' => 'foo', 'extraTwo' => 'bar'], $body->serialize());
    }
    ...
    {
        $body = TelemetryBody::fromArray(['message' => 'message', 'method' => 'method', 'url' => 'url', 'status_code' => 'status', 'subtype' => 'sub', 'stack' => 'stack', 'from' => 'from', 'to' => 'to', 'start_timestamp_ms' => 42, 'end_timestamp_ms' => 43, 'extraOne' => 'foo', 'extraTwo' => 'bar']);
        self::assertSame('message', $body->message);
        self::assertSame('method', $body->method);
        self::assertSame('url', $body->url);
        self::assertSame('status', $body->status_code);
