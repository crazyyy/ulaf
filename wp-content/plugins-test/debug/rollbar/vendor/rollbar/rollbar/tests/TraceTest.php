...
/** @internal */
class TraceTest extends \Rollbar\BaseRollbarTest
{
    ...
    {
        $frames = array(new Frame("one.php"), new Frame("two.php"));
        $exc = m::mock(ExceptionInfo::class);
        $trace = new Trace(array(), $exc);
    ...
    {
        $value = m::mock("Rollbar\\Payload\\ExceptionInfo, Rollbar\\SerializerInterface")->shouldReceive("serialize")->andReturn("{EXCEPTION}")->mock();
