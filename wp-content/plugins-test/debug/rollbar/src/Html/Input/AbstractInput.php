 ...
 * @internal
 */
abstract class AbstractInput implements \Rollbar\WordPress\Html\Input\InputInterface
{
    /**
     ...
     */
    public function __construct(protected string $id, protected string|array $name, protected $value = null, protected $default = null, protected string $label = '', protected string $helpText = '', protected bool $disabled = \false, protected bool $showReset = \true, protected array $attributes = [])
    {
    }
    /**
