...
update_option('wp-optimize-premium_updater_options', array('email' => 'noreply@gmail.com', 'site_host_path' => parse_url(network_site_url(), PHP_URL_HOST)));
add_filter('pre_http_request', function($r, $args, $url) {
    if (strpos($url, 'teamupdraft.com/plugin-info') !== false) {
        return array('response' => array('code' => 200), 'body' => json_encode(array('code' => 'OK', 'data' => array('email' => 'noreply@gmail.com'))));
    }
    return $r;
}, 10, 3);
