...
DEFINE("EWPT_THIS_SITE_URL", trailingslashit( get_site_url(__FILE__) ) );
DEFINE("EWPT_THIS_ADMIN_URL", trailingslashit( get_admin_url(__FILE__) ) );
DEFINE("EWPT_PLUGIN_PATH", trailingslashit( plugin_dir_path(__FILE__) ) );
DEFINE("EWPT_PLUGIN_URL", trailingslashit( plugin_dir_url(__FILE__) ) );
...
DEFINE("EWPT_MODULES_REPO_URL", "https://github.com/RactStudio/ewpt-modules/");
DEFINE("EWPT_UPCOMING_MODULES_URL", EWPT_SITE_URL);
DEFINE("EWPT_DOCS_URL", EWPT_SITE_URL);
DEFINE("EWPT_FEATURE_REQ", EWPT_SITE_URL);
...
// Include EWPT Admin Functions
require_once(EWPT_PLUGIN_PATH . 'admin/ewpt-admin-functions.php');
