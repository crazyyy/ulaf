...
if ( isset( $_GET[ 'error' ] ) || count( $this->ctc()->errors ) ):
    include_once( CHLD_THM_CFG_DIR . '/includes/views/errorstrings.php' );
...
<div class="updated notice is-dismissible">
    ...
    <?php
        ...
        ?>
    <p>
        <?php _e( 'Settings updated successfully.', 'child-theme-configurator' ); ?>
    </p>    <?php
            break;
        case '7':
        ?>
    ...
    <?php
        ...
        ?>
    <p>
        <?php _e( 'Child Theme files updated successfully.', 'child-theme-configurator' ); ?>
    </p>
    <?php
            break;
        default: ?>
