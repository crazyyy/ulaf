...
class Database extends Panel {
    ...
    public function get_table_object() {
        if ( is_null( $this->table_object ) && class_exists( '\\Dev4Press\\Plugin\\SweepPress\\Pro\\Table\\Database' ) ) {
            $this->table_object = new \Dev4Press\Plugin\SweepPress\Pro\Table\Database();
        }
