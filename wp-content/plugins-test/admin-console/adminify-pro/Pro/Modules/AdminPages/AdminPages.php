...
?>
	...
	public function addCustomScripts()
	{
		...
		$template_css = 'html{background-image: none !important;}body.single-adminify_admin_page { background: #f9f9f9; }body.single-adminify_admin_page { overflow-y: hidden; }body.single-adminify_admin_page h1.adminify-admin-page--title { font-size: 2.5em; margin: 30px 0; }';
