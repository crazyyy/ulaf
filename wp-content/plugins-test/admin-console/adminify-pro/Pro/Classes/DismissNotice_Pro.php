...
<?php
	...
	public static function adminify_hide_notice_forever()
	{
		...
		// Security check - only administrators can hide notices forever
	...
	public function adminify_log_notices()
	{
		...
		// Security check - only administrators can log notices
		if (!current_user_can('manage_options')) {
			wp_send_json_error(array('message' => __('You do not have permission to perform this action.', 'adminify')));
		}
	...
	public function admin_notices_secondary_menu_wrap()
	{
		...
		<style>
			...
			.adminify-notices-wrapper > *:not(.hide-notice--ignored):not(.wp-adminify-notice--ignored) {
