...
class Renamer_Integration_Manager {
    ...
    private function load_active_integrations() {
        ...
        if ($this->is_integration_enabled('elementor')) {
            $this->load_integration('elementor', 'ImgSEO_Elementor_Integration');
        }
        
        // Visual Composer
        if ($this->is_integration_enabled('visualcomposer')) {
            $this->load_integration('visualcomposer', 'ImgSEO_VisualComposer_Integration');
        }

        // Divi
        if ($this->is_integration_enabled('divi')) {
            $this->load_integration('divi', 'ImgSEO_Divi_Integration');
        }
        
        // Beaver Builder
        if ($this->is_integration_enabled('beaver')) {
            $this->load_integration('beaver', 'ImgSEO_Beaver_Integration');
        }
    }
