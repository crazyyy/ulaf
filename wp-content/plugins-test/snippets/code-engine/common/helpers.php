...
if ( !class_exists( 'MeowKit_MWCODE_Helpers' ) ) {

  class MeowKit_MWCODE_Helpers {
    //public static $version = MeowKit_MWCODE_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_MWCODE_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_MWCODE_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_MWCODE_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_MWCODE_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_MWCODE_Helpers::$startQueries[ $timerName ];
  ...
  // if ( MeowKit_MWCODE_Helpers::is_rest() ) {
