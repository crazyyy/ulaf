                    ...
                    <div class="script-fields">
                        <div class="form-controls">
                            <div class="form-control">
                                ...
                                <input type="text" id="script-title" name="title" value="<?= $edit_script["title"] ?>" required>
                            </div>

                            <div class="form-control">
                                <label for="script-description">Description</label>
                                <textarea id="script-description" name="description" data-autoheight><?= $edit_script["description"] ?></textarea>
                            </div>
                            ...
                            <div class="form-control" data-dependon="#script-location" data-dependon-value="!shortcode">
                            ...
                            <div class="form-control script-url" data-dependon="#script-type" data-dependon-value="url/.+">
                                <label for="script-url">URL</label>
                                <a class="btn-script-upload" data-action="uploadScriptFile"><?= $this->icon("upload", 16, 16) ?> Upload</a>
                        ...
                        <div class="form-actions">
                            ...
                            <button class="button button-secondary" data-action="toggleFormStatus">
