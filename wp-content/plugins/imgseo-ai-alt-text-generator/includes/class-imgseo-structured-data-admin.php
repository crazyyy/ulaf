...
class ImgSEO_Structured_Data_Admin {
    ...
    public function register_settings() {
        ...
        add_settings_section(
            ...
            '', // Title removed - page already has main title from WordPress
        ...
        add_settings_field(
            ...
            __('Enable JSON-LD Structured Data', 'imgseo-ai-alt-text-generator'),
        ...
        add_settings_field(
            ...
            __('Include Thumbnail URLs', 'imgseo-ai-alt-text-generator'),
        ...
        add_settings_field(
            ...
            __('Include Author Information', 'imgseo-ai-alt-text-generator'),
        ...
        add_settings_field(
            ...
            __('Maximum Images per Page', 'imgseo-ai-alt-text-generator'),
    ...
    public function render_section_description() {
        echo '<p>' . esc_html__('Configure how JSON-LD structured data is generated for your images. This helps search engines better understand your image content.', 'imgseo-ai-alt-text-generator') . '</p>';
    }
    ...
    public function render_enable_field() {
        ...
        <label>
            ...
            <?php esc_html_e('Enable JSON-LD structured data for images', 'imgseo-ai-alt-text-generator'); ?>
        </label>
        <p class="description">
            <?php esc_html_e('Automatically inserts JSON-LD markup for images on pages. This helps search engines better understand your images.', 'imgseo-ai-alt-text-generator'); ?>
        </p>
        <?php
    }
    ...
    public function render_thumbnails_field() {
        ...
        <label>
            ...
            <?php esc_html_e('Include thumbnail URLs in structured data', 'imgseo-ai-alt-text-generator'); ?>
        </label>
        <p class="description">
            <?php esc_html_e('Includes thumbnail URLs in the JSON-LD structured data for better image representation.', 'imgseo-ai-alt-text-generator'); ?>
        </p>
        <?php
    }
    ...
    public function render_author_field() {
        ...
        <label>
            ...
            <?php esc_html_e('Include author information in structured data', 'imgseo-ai-alt-text-generator'); ?>
        </label>
        <p class="description">
            <?php esc_html_e('Includes the image author information in the JSON-LD structured data.', 'imgseo-ai-alt-text-generator'); ?>
        </p>
        <?php
    }
    ...
    public function render_max_images_field() {
        ...
        <p class="description">
            <?php esc_html_e('Maximum number of images to process per page for structured data (1-50). Lower values improve performance.', 'imgseo-ai-alt-text-generator'); ?>
        </p>
        <?php
    }
