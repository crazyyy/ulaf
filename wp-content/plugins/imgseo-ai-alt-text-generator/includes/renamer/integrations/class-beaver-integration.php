<?php
/**
 * Class ImgSEO_Beaver_Integration
...
class ImgSEO_Beaver_Integration implements Renamer_Integration_Interface {
    
    /**
     * Updates image references in Beaver Builder
     * 
    ...
    public function update_references($old_urls, $new_urls, $attachment_id) {
        ...
        if (!class_exists('FLBuilder')) {
            return array(
                'status' => false,
                'updated' => 0,
                'message' => __('Beaver Builder is not active', 'imgseo-ai-alt-text-generator')
            );
        }
        ...
        // 1. Update Beaver Builder metadata
        ...
        // 2. Update Beaver Builder templates
        ...
        // 3. Update CSS generated by Beaver Builder
        $css_meta_keys = array(
            '_fl_builder_css',
        ...
        return array(
            ...
            'message' => sprintf(
                // translators: %1$d is the number of references updated in posts/pages, %2$d is the number of Beaver Builder templates updated
                __('Updated %1$d references in posts/pages and %2$d Beaver Builder templates', 'imgseo-ai-alt-text-generator'),
                $updated_count, 
                $updated_templates
            )
        );
