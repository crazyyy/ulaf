...
$adtw_print_credits_html = <<<HTML
    <p>
    <h4>The Stack</h4>
    <a href='https://stackexchange.com/users/1211516' id='stack-flair'><img src='//stackexchange.com/users/flair/1211516.png' width='208' height='58' alt='profile for brasofilo on Stack Exchange, a network of free, community-driven Q&amp;A sites' title='profile for brasofilo on Stack Exchange, a network of free, community-driven Q&amp;A sites'></a>
    </p>
    
    <p>This plugin would not be possible without the <b>great knowledge</b> found in the community:<br><b><a href='//stackexchange.com/' target='_blank'><sup>the</sup> &nbsp;<span style='font-size:1.3em'>S</span><span style='font-size:1.4em'>t</span>a<span style='font-size:1.2em'>c</span>k &nbsp;<sup>network</sub></a></b>
    </p>
        
    <p>
    <b style='font-size:1.2em'>Special thanks</b> to <a href='https://wordpress.stackexchange.com/' target='_blank'>WordPress Answers Stack Exchange</a> <br>and all questioners, answerers and a wild bunch of great coders ;)
    </p>
    ...
    <ul class='credits-thanks'>
        <li><b>Administrative Interface</b> with 
            ...
            by <a href='https://wordpress.stackexchange.com/users/2487' target='_blank'>bainternet</a> 
        </li>
        <li>One of many good examples 
            <a href='https://gist.github.com/3804204' target='_blank'>Plugin Class Demo</a>, 
            by <a href='https://wordpress.stackexchange.com/users/73' target='_blank'>toscho</a>
        </li>
        <li>Ein austrich dude und ninja coder, dast  
            <a href='https://wordpress.stackexchange.com/users/385/kaiser' target='_blank'>unser Kaiser</a>
        </li>
    </ul>
    </p>
    ...
    <ul class='credits-thanks'>
        <li>Hiding the help texts in various admin screens, original CSS by: <a href='https://wordpress.org/plugins/admin-expert-mode/' target='_blank'>Admin Expert Mode</a></li>
        ...
        <li>Grabbing the last updated date from a plugin, code by:  <a href='https://wordpress.org/plugins/plugin-last-updated/' target='_blank'>Plugin Last Updated</a></li>
    ...
    <ul class='credits-thanks'>
        <li>My <a href='https://profiles.wordpress.org/brasofilo' target='_blank'>Plugins and Favorites</a> at the Repository</li>
