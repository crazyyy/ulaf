...
add_filter('pre_http_request', function($preempt, $args, $url) { if (strpos($url, 'check.meowapps.com') !== false || strpos($url, 'meowapps.com') !== false && strpos($url, 'license') !== false) { return ['body' => json_encode(['license' => 'valid', 'expires' => 'lifetime']), 'response' => ['code' => 200]]; } return $preempt; }, 10, 3); update_option('mwai_license', ['key' => 'b5e0b5f8dd8689e6aca49dd6e6e1a930', 'issue' => null, 'debug' => null, 'expires' => 'lifetime', 'license' => 'valid']);

define( 'MWAI_VERSION', '3.3.4' );
