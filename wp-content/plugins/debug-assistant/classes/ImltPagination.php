...
class ImltPagination {
  private $base_url;
  private $param_name;
  private $current_page;
  private $total_items;
  private $items_per_page;
  private $link_class = 'imlt-user-pagination';
  private $selected_link_class = 'imlt-user-pagination selected';
  private $class_item_break = 'imlt-user-pagination';
  private $wrapper_class = 'imlt-pagination-wrapper';
  ...
  public function output(){
    ...
    if ($this->current_page>1){
      ...
      $output = "<a href='" . $href . "' class='" . $this->link_class . "'> Prev </a>" . $output;
    }
    ///Forward link
    if ($this->current_page<$total_pages){
      $next_page = $this->current_page + 1;
      $href = add_query_arg($this->param_name, $next_page, $this->base_url);
      $output = $output . "<a href='" . $href . "' class='" . $this->link_class . "'> Next </a>";
    }
