<?php
    ...
    #--------------------------------------------------------------------------------
    #region SDK Version Override (Modified by GPL Times - https://www.gpltimes.com)
    #--------------------------------------------------------------------------------
    ...
    #--------------------------------------------------------------------------------
    #region Mock Plan Configuration (Modified by GPL Times - https://www.gpltimes.com)
    #--------------------------------------------------------------------------------

    if ( ! defined( 'WP_FS__MOCK_PLAN_NAME' ) ) {
        define( 'WP_FS__MOCK_PLAN_NAME', 'pro' );
    }
    if ( ! defined( 'WP_FS__MOCK_PLAN_TITLE' ) ) {
        define( 'WP_FS__MOCK_PLAN_TITLE', 'Pro Plan' );
    }
