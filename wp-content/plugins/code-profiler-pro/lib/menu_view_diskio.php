...
$buffer = code_profiler_pro_get_profile_data( $profile_path, 'diskio' );
...
$label  = "'".
			esc_js( __('I/O Read bytes', 'code-profiler-pro') ) .
			"', '".
			esc_js( __('I/O Write bytes', 'code-profiler-pro') ) .
			"'";
...
<?php
	echo "<table>\n".
		"\t<tr>\n".
		"\t\t<td>".	esc_html__('I/O Read bytes', 'code-profiler-pro') 		."</td>".
		"<td>".		esc_html__('I/O Write bytes', 'code-profiler-pro') ."</td>\n".
