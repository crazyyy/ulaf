...
echo code_profiler_pro_display_tabs( 6 );
?>
<br />
<p><?php esc_html_e('When contacting the support for help, please copy and paste the system information report below in your ticket:', 'code-profiler-pro') ?></p>
<table class="form-table">
	<tr>
		<td>
			...
			?></textarea>
			<p><input type="button" onClick="cpjspro_copy_textarea('cp-troubleshooter')" class="button-secondary" value="<?php esc_attr_e('Copy text', 'code-profiler-pro') ?>" /></p>
		</td>
	</tr>
</table>
<?php
