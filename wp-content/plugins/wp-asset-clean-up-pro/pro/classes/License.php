...
/*
                    ...
                    <tr valign="top" class="wpacu-license-extra-info">
                        ...
                        <td style="padding-bottom: 18px;">
	                        <span style="background: rgba(255, 255, 255, 0.5); border: 1px solid #e7e7e7; border-radius: 4px; padding: 5px;">
	                            ...
	                            echo (int)$license_data->site_count.' / <strong>'.$licenseLimit.'</strong>';
								?>
	                        </span>
	                        <?php
                            echo '&nbsp;&nbsp;';
				...
				if ($license_data->license === 'expired' && $responseArray['new_license_status'] === '') {
				...
				if ( $responseArray['new_license_status'] === 'valid' || (isset($license_data->license) && $license_data->license === 'valid') ) {
