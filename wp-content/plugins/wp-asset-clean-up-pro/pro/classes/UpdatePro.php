	...
	public function updatePluginRules()
	{
		...
		foreach ( $wpacuPluginsPostData as $pluginPath => $pluginRuleData ) {
			...
			foreach (array('unload_via_regex', 'load_via_regex', 'unload_via_post_type', 'load_via_post_type') as $keyStatus) {
			    ...
			    } elseif (in_array($keyStatus, array('unload_via_post_type', 'load_via_post_type', 'unload_via_tax', 'load_via_tax'))) {
            ...
            if (isset($values['status']) && ! empty($values['status'])) {
                foreach ($values['status'] as $statusKey => $status) {
                    if (! isset($values[$status]) &&
                        in_array($status, array('unload_via_post_type', 'load_via_post_type', 'unload_via_tax', 'load_via_tax'))) {
