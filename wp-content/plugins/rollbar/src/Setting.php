...
final class Setting
{
     ...
     */
    public function __construct(public readonly string $id, public readonly SettingType $type, public readonly string $label = '', public readonly string $helpText = '', public readonly mixed $default = null, public readonly array $options = [], public readonly string $section = 'rollbar_wp_advanced', public readonly array $inputArgs = [], public readonly bool $alwaysSave = \false)
    {
    ...
    {
        $this->input->setValue($args['value'] ?? \Rollbar\WordPress\Plugin::getInstance()->getSetting($this->id));
        echo $this->input;
    }
    /**
    ...
    public function coerceValue(mixed $value) : mixed
    {
        return match ($this->type) {
            SettingType::Boolean => \Rollbar\WordPress\Settings::toBoolean($value),
            SettingType::CheckBox => \Rollbar\WordPress\Settings::toStringArray($value),
            SettingType::Integer => \Rollbar\WordPress\Settings::toInteger($value),
            SettingType::Select, SettingType::Text => \Rollbar\WordPress\Settings::toString($value),
    ...
    private function createInput() : null|InputInterface
    {
        ...
        $args = ['id' => 'rollbar_wp_' . $this->id, 'name' => ['rollbar_wp', $this->id], 'default' => $this->default, 'label' => '', 'helpText' => $this->helpText];
