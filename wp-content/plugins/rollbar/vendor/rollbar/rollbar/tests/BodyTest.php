...
/** @internal */
class BodyTest extends \Rollbar\BaseRollbarTest
{
    ...
    {
        $value = m::mock(ContentInterface::class)->shouldReceive("serialize")->andReturn("{CONTENT}")->shouldReceive("getKey")->andReturn("content_interface")->mock();
    ...
    public function testSerialize() : void
    {
        ...
        $this->assertEquals("{\"content_interface\":\"{CONTENT}\",\"extra\":{\"foo\":\"bar\"}}", $encoded);
    }
    public function testSerializeWithMaxNestingDepth() : void
    {
        ...
        $this->assertEmpty($resultWithLimit['extra']['deep']);
        // Truncated due to depth limit
    }
}
