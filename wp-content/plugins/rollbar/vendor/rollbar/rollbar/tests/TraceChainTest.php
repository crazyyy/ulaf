...
namespace Rollbar\Payload\TraceChain;
...
class TraceChainTest extends Rollbar\BaseRollbarTest
{
    ...
    {
        $trace1 = m::mock(Trace::class)->shouldReceive("serialize")->andReturn("TRACE1")->mock();
        $trace2 = m::mock(Trace::class)->shouldReceive("serialize")->andReturn("TRACE2")->mock();
