...
class TelemetryEventTest extends BaseRollbarTest
{
    ...
    {
        $event = new TelemetryEvent(EventType::Network, EventLevel::Info, ['method' => 'GET', 'url' => 'https://example.com', 'status_code' => '200', ['unstructured' => 'data', 0 => 'foo']]);
        ...
        self::assertSame([['unstructured' => 'data', 0 => 'foo']], $event->body->extra);
    }
}
