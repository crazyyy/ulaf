 ...
 * @internal
 */
class VerbosityTest extends \Rollbar\BaseRollbarTest
{
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', "enabled" => \true, 'verbose_logger' => $this->verboseLogger]);
        \Rollbar\Rollbar::log(Level::WARNING, "Testing PHP Notifier");
        $this->assertVerboseLogsConsecutive(['level' => LogLevel::INFO, 'messageRegEx' => 'Attempting to log: \\[warning\\] Testing PHP Notifier'], ['level' => LogLevel::INFO, 'messageRegEx' => 'Occurrence']);
    }
    /**
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', "enabled" => \false, 'verbose_logger' => $this->verboseLogger]);
        \Rollbar\Rollbar::log(Level::WARNING, "Testing PHP Notifier");
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger]);
        $this->expectException(\RollbarWP\Psr\Log\InvalidArgumentException::class);
        \Rollbar\Rollbar::log('nolevel', "Testing PHP Notifier");
    ...
    public function testRollbarLoggerInternalCheckIgnored() : void
    {
        ...
        \error_reporting(0);
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger]);
        \Rollbar\Rollbar::log(LogLevel::INFO, "Testing PHP Notifier");
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'check_ignore' => function () {
            return \true;
        }]);
        \Rollbar\Rollbar::log(LogLevel::WARNING, "Testing PHP Notifier");
        $this->assertVerboseLogContains('Occurrence ignored', LogLevel::INFO);
    }
    /**
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'max_items' => 0]);
        \Rollbar\Rollbar::log(LogLevel::INFO, "Testing PHP Notifier");
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'batched' => \true]);
        \Rollbar\Rollbar::log(LogLevel::INFO, "Testing PHP Notifier");
    ...
    public function testRollbarConfigInternalCheckIgnoredShouldSuppress() : void
    {
        ...
        \error_reporting(0);
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger]);
        \Rollbar\Rollbar::logger()->getConfig()->internalCheckIgnored(LogLevel::WARNING, "Some message");
        $this->assertVerboseLogContains('Ignoring \\(error reporting has been disabled in PHP config\\)', LogLevel::DEBUG);
        \error_reporting($errorReporting);
    }
    /**
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'minimum_level' => LogLevel::ERROR]);
        \Rollbar\Rollbar::logger()->getConfig()->internalCheckIgnored(LogLevel::WARNING, "Some message");
    ...
    public function testRollbarConfigShouldIgnoreErrorErrorReporting() : void
    {
        ...
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'use_error_reporting' => \true]);
        \Rollbar\Rollbar::logger()->getConfig()->shouldIgnoreError(\E_WARNING);
    ...
    public function testRollbarConfigShouldIgnoreErrorIncludedErrno() : void
    {
        $errorReporting = \error_reporting();
        \error_reporting(0);
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'included_errno' => \E_WARNING]);
        \Rollbar\Rollbar::logger()->getConfig()->shouldIgnoreError(\E_ERROR);
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'error_sample_rates' => array(\E_WARNING => 0)]);
        \Rollbar\Rollbar::logger()->getConfig()->shouldIgnoreError(\E_WARNING);
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'exception_sample_rates' => array('Exception' => 0)]);
        \Rollbar\Rollbar::logger()->getConfig()->shouldIgnoreException(new \Exception());
    ...
    public function testRollbarConfigCheckIgnored() : void
    {
        ...
        \Rollbar\Rollbar::logger()->getConfig()->checkIgnored($payloadMock, $payloadMock, \false);
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'minimum_level' => \Rollbar\Payload\Level::ERROR]);
        $config = \Rollbar\Rollbar::logger()->getConfig();
    ...
    {
        $filterMock = $this->getMockBuilder(\Rollbar\FilterInterface::class)->getMock();
        $filterMock->method('shouldSend')->willReturn(\true);
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'filter' => $filterMock]);
        $config = \Rollbar\Rollbar::logger()->getConfig();
        $data = $config->getRollbarData(\Rollbar\Payload\Level::INFO, 'some message', array());
        $payload = new \Rollbar\Payload\Payload($data, $this->getTestAccessToken());
        $config->checkIgnored($payload, 'some message', \false);
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'transmit' => \false]);
        $config = \Rollbar\Rollbar::logger()->getConfig();
        $encoded = new \Rollbar\Payload\EncodedPayload(array());
        $config->send($encoded, $this->getTestAccessToken());
        $this->assertVerboseLogContains('Not transmitting \\(transmitting disabled in configuration\\)', LogLevel::WARNING);
    }
    /**
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'transmit' => \false, 'batched' => \true]);
        $config = \Rollbar\Rollbar::logger()->getConfig();
    ...
    {
        $responseHandlerMock = $this->getMockBuilder(\Rollbar\ResponseHandlerInterface::class)->getMock();
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger, 'responseHandler' => $responseHandlerMock]);
        $config = \Rollbar\Rollbar::logger()->getConfig();
        $payloadMock = $this->getMockBuilder(Payload::class)->disableOriginalConstructor()->getMock();
        $responseMock = $this->getMockBuilder(\Rollbar\Response::class)->disableOriginalConstructor()->getMock();
    ...
    {
        \Rollbar\Rollbar::init(['access_token' => $this->getTestAccessToken(), 'environment' => 'testing-php', 'verbose_logger' => $this->verboseLogger]);
        \Rollbar\Rollbar::logger()->log(\Rollbar\Payload\Level::INFO, \str_repeat("x", \Rollbar\Truncation\Truncation::MAX_PAYLOAD_SIZE));
    ...
    {
        self::assertGreaterThanOrEqual(0, $this->verboseLogger->indexOfRegex($level, $messageRegEx), 'Verbose log does not contain expected message: "' . $messageRegEx . '" at level "' . $level . '"');
    }
    /**
    ...
    private function assertVerboseLogsConsecutive(array ...$constraints) : void
    {
        ...
        for ($i = 0; $i < \count($this->verboseLogger->logs); $i++) {
            ...
            if ($consecutive && !$matches) {
                ...
                $this->fail('Expected log message at index "' . $i . '" to match "' . $message . '" at level "' . $level . '"');
            }
            if ($matches) {
        ...
        self::assertSame(\count($constraints), $matchCount, 'Expected ' . \count($constraints) . ' log messages, but found ' . $matchCount);
    }
}
