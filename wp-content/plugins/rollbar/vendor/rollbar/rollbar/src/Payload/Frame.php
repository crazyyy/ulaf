...
class Frame implements SerializerInterface
{
    ...
    private ?\Rollbar\Payload\Context $context = null;
    ...
    public function getContext() : ?\Rollbar\Payload\Context
    {
        return $this->context;
    }
    public function setContext(\Rollbar\Payload\Context $context) : self
    {
    ...
    {
        $result = array("filename" => $this->filename, "lineno" => $this->lineno, "colno" => $this->colno, "method" => $this->method, "code" => $this->code, "context" => $this->context, "args" => $this->args);
