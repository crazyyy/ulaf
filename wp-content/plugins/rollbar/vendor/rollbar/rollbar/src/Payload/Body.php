...
class Body implements SerializerInterface
{
     ...
     */
    public function __construct(private \Rollbar\Payload\ContentInterface $value, private array $extra = [], private ?array $telemetry = null, private int $maxDepth = -1)
    {
    }
    /**
     ...
     */
    public function getValue() : \Rollbar\Payload\ContentInterface
    {
        return $this->value;
    }
    /**
     ...
     * @return self
     */
    public function setValue(\Rollbar\Payload\ContentInterface $value) : self
    {
        $this->value = $value;
        return $this;
    }
