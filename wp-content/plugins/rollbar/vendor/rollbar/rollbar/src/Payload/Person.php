...
class Person implements SerializerInterface
{
     ...
     */
    private array $extra;
    public function __construct(private string $id, private ?string $username = null, private ?string $email = null, array $extra = [])
    {
    ...
    {
        $result = array("id" => $this->id, "username" => $this->username, "email" => $this->email);
