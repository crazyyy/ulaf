...
{
    use UtilitiesTrait;
    public const DEFINED_KEYS = ['message', 'method', 'url', 'status_code', 'subtype', 'stack', 'element', 'from', 'to', 'start_timestamp_ms', 'end_timestamp_ms'];
    /**
     ...
     */
    public function __construct(public string $message = '', public string $method = '', public string $url = '', public string $status_code = '', public string $subtype = '', public ?string $stack = null, public string $from = '', public string $to = '', public ?int $start_timestamp_ms = null, public ?int $end_timestamp_ms = null, mixed ...$extra)
    {
        $this->extra = $extra;
    }
    /**
    ...
    public function serialize() : array
    {
        ...
        $result = \array_filter(['message' => $this->message, 'method' => $this->method, 'url' => $this->url, 'status_code' => $this->status_code, 'subtype' => $this->subtype, 'stack' => $this->stack, 'from' => $this->from, 'to' => $this->to, 'start_timestamp_ms' => $this->start_timestamp_ms, 'end_timestamp_ms' => $this->end_timestamp_ms]);
        if (empty($this->extra)) {
            return $result;
        }
