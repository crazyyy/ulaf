...
class Request implements SerializerInterface
{
    ...
    {
        $result = array("url" => $this->url, "method" => $this->method, "headers" => $this->headers, "params" => $this->params, "GET" => $this->get, "query_string" => $this->queryString, "POST" => $this->post, "body" => $this->body, "user_ip" => $this->userIp);
