...
class ErrorWrapper extends \Exception
{
     ...
     */
    public function __construct(public int $errorLevel, public string $errorMessage, public ?string $errorFile, public ?int $errorLine, public ?array $backTrace, $utilities)
    {
