...
class LevelFactory
{
    ...
    {
        if (null === self::$levels) {
            self::$levels = array(Level::EMERGENCY => new Level("critical", 100000), Level::ALERT => new Level("critical", 100000), Level::CRITICAL => new Level("critical", 100000), Level::ERROR => new Level("error", 10000), Level::WARNING => new Level("warning", 1000), Level::NOTICE => new Level("info", 100), Level::INFO => new Level("info", 100), Level::DEBUG => new Level("debug", 10));
        }
        return self::$levels;
    }
    /**
