...
use RollbarWP\Monolog\Formatter\LineFormatter;
use RollbarWP\Monolog\Formatter\FormatterInterface;
use RollbarWP\Monolog\Level;
use RollbarWP\Monolog\Utils;
use RollbarWP\PhpConsole\Connector;
use RollbarWP\PhpConsole\Handler as VendorPhpConsoleHandler;
use RollbarWP\PhpConsole\Helper;
use RollbarWP\Monolog\LogRecord;
use RollbarWP\PhpConsole\Storage;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('RollbarWP\\PhpConsole\\Connector')) {
