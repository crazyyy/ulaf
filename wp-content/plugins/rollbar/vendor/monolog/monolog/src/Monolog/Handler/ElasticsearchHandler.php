 ...
 */
namespace RollbarWP\Monolog\Handler;

use RollbarWP\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use RollbarWP\Monolog\Level;
use RollbarWP\Monolog\Formatter\FormatterInterface;
use RollbarWP\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use RollbarWP\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use RollbarWP\Elasticsearch\Client;
use RollbarWP\Monolog\LogRecord;
use RollbarWP\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use RollbarWP\Elastic\Elasticsearch\Client as Client8;
/**
