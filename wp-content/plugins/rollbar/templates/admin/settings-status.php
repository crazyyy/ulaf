...
echo new BooleanInput(id: 'rollbar_wp_php_logging_enabled', name: ['rollbar_wp', 'php_logging_enabled'], value: $php_logging_enabled, label: 'Turn on logging with PHP', showReset: \false);
?>
<div id="rollbar_wp_server_side_access_token_container" class="hidden">
    ...
    <?php 
echo new TextInput(id: 'rollbar_wp_server_side_access_token', name: ['rollbar_wp', 'server_side_access_token'], value: $server_side_access_token, showReset: \false, attributes: ['style' => 'width: 400px;']);
?>
    <p class="description">
...
<br/>
<?php 
echo new BooleanInput(id: 'rollbar_wp_js_logging_enabled', name: ['rollbar_wp', 'js_logging_enabled'], value: $js_logging_enabled, label: 'Turn on logging with JavaScript (with rollbar.js)', showReset: \false);
?>
<div id="rollbar_wp_client_side_access_token_container" class="hidden">
    ...
    <?php 
echo new TextInput(id: 'rollbar_wp_client_side_access_token', name: ['rollbar_wp', 'client_side_access_token'], value: $client_side_access_token, showReset: \false, attributes: ['style' => 'width: 400px;']);
?>
</div>
<p class="description">
