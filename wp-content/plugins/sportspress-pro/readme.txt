...
= 2.7.27 =
* Fix - Returning zeros in career totals.

= 2.7.26 =
* Tweak - Make team access user meta compatible with multisite.
* Tweak - Change the logic of midseason transfers from date to team.
* Tweak - Make SportsPress compatible with the Polylang plugin.
* Fix - Bypass same highlight color not working.
