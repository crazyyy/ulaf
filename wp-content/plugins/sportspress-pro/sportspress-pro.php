...
update_option('sportspress_pro_license_key', 'xxxxxxxxxxxxxxxx');
...
final class SportsPress_Pro {
	...
	public function __construct() {
		...
		add_filter( 'wp_plugin_dependencies_slug', array( $this, 'convert_sportspress_to_sportspress_pro' ) );
	...
	/**
	 * Make SportsPress Pro compatible with Required Plugins header.
	 */
	public function convert_sportspress_to_sportspress_pro( $slug ) {
		if ( 'sportspress' === $slug ) {
			$slug = 'sportspress-pro';
		}
		return $slug;
	}
