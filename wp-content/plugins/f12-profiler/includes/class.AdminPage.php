	...
	class AdminPage {
		...
		private function __construct() {
			...
			if ( isset( $_POST['f12_profiler_save'] ) ) {
                if ( ! isset( $_POST['f12_profiler_nonce'] ) ||
                    ! check_admin_referer( 'f12_profiler_save_action', 'f12_profiler_nonce' ) ) {
                    return;
                }
		...
		public function wp_showPage() {
			...
			echo Template::getInstance()->getTemplate( 'admin', $atts ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output escaped and validated in Template admin.php. No user data is included.
		}
	}
}