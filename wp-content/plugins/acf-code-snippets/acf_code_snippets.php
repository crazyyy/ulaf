     ...
     function init(){
          ...
          <?php
           ...
           function acf_code_snippet_repeater_output($group, $is_sub_field = false){
             ...
             ?>
             <code>
             if( have_rows('<?php echo $group["name"]; ?>') ):<br>
             &emsp;while( have_rows('<?php echo $group["name"]; ?>') ): the_row();<br>
             <?php
           ...
           <?php endif; ?>
               <code>
               the<?php echo $this->sub_field_code($is_sub_field); ?>_field("<?php echo $group["name"]; ?>");
             </code>
             <?php
             $code = ob_get_contents();
             ob_end_clean();
           ...
           function acf_code_snippet_gallery_output($group, $is_sub_field = false){
             ...
             <br />
             if( $<?php echo $group["name"]; ?> ):<br />
              &emsp;foreach( $<?php echo $group["name"]; ?> as $image ):<br />
              &emsp;&emsp;$id = $image['ID'];<br />
              &emsp;&emsp;$url = $image['url'];<br />
              &emsp;&emsp;$alt = $image['alt'];<br />
              &emsp;&emsp;$caption = $image['caption'];<br />
              &emsp;endforeach;<br />
             endif;<br />
           </code>
             <?php
