...
update_option( 'wpcode_license', [ 'key' => 'C6D0D7F8DB6898D6ACA49DC6C9F4B996', 'type' => 'elite', 'is_expired' => false, 'is_disabled' => false, 'is_invalid' => false, ] ); add_filter( 'pre_http_request', function( $preempt, $parsed_args, $url ) { if ( $url === 'https://licensing.wpcode.com/v1/activate/' && isset($parsed_args['method']) && strtoupper($parsed_args['method']) === 'POST' ) { $responseBody = json_encode([ "success" => true, "license" => "valid", "item_id" => 44997, "item_name" => "WPCode Pro", "license_limit" => 25, "site_count" => 1, "expires" => "2050-01-01 23:59:59", "activations_left" => 24, "checksum" => "C6D0D7F8DB6898D6ACA49DC6C9F4B996", "payment_id" => 123321, "customer_name" => "GPL", "customer_email" => "noreply@gmail.com", "price_id" => "3" ]); $mock_response = [ 'headers' => [], 'body' => $responseBody, 'response' => [ 'code' => 200, 'message' => 'OK' ], ]; return $mock_response; } return $preempt; }, 10, 3 );
