...
namespace DebugSuite\Packages\League\Container;

use DebugSuite\Packages\League\Container\Definition\{DefinitionAggregate, DefinitionInterface, DefinitionAggregateInterface};
use DebugSuite\Packages\League\Container\Exception\{NotFoundException, ContainerException};
use DebugSuite\Packages\League\Container\Inflector\{InflectorAggregate, InflectorInterface, InflectorAggregateInterface};
use DebugSuite\Packages\League\Container\ServiceProvider\{ServiceProviderAggregate,
    ServiceProviderAggregateInterface,
    ServiceProviderInterface};
use DebugSuite\Packages\Psr\Container\ContainerInterface;
