...
class MGWPP_Admin_Assets
{
    ...
    private function load_core_assets()
    {
        ...
        // Also provide mgwppAdmin for consistency with galleries view scripts
        wp_localize_script(
            'mgwpp-admin-core',
            'mgwppAdmin',
            [
    ...
    public static function enqueue_preview_assets($gallery_id)
    {
        ...
        switch ($gallery_type) {
            ...
            case '3d_model_carousel':
                if (!wp_style_is('mgwpp-3d-model-carousel-styles', 'registered')) {
                    wp_register_style(
                        'mgwpp-3d-model-carousel-styles',
                        MG_PLUGIN_URL . '/includes/gallery-types/mgwpp-3d-model-carousel/mgwpp-3d-model-carousel.css',
                        ['mgwpp-frontend'],
                        self::get_gallery_asset_version('/includes/gallery-types/mgwpp-3d-model-carousel/mgwpp-3d-model-carousel.css')
                    );
                }
                if (!wp_script_is('mgwpp-3d-model-carousel-js', 'registered')) {
                    wp_register_script(
                        'mgwpp-3d-model-carousel-js',
                        MG_PLUGIN_URL . '/includes/gallery-types/mgwpp-3d-model-carousel/mgwpp-3d-model-carousel.js',
                        ['jquery'],
                        self::get_gallery_asset_version('/includes/gallery-types/mgwpp-3d-model-carousel/mgwpp-3d-model-carousel.js'),
                        true
                    );
                }
