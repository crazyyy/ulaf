...
class MGWPP_Upload
{
    public static function mgwpp_create_gallery()
    {
        ...
        if ($existing) {
            wp_die(
                esc_html_e('Gallery with this name already exists! Please use a unique name.', 'mini-gallery'),
                esc_html_e('Duplicate Gallery', 'mini-gallery'),
                ['response' => 400]
            );
        }
        ...
        wp_safe_redirect(admin_url('admin.php?page=mgwpp_galleries'));
        exit;
    }
