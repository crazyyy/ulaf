class MGWPP_FullPageSlider {
    constructor(container) {
        ...
        this.slider = container.closest('.mg-fullpage-slider');
        ...
        this.autoPlay = this.slider?.dataset.autoplay !== 'false';
        this.slideDuration = parseInt(this.slider?.dataset.duration, 10) || 6000;
    ...
    init() {
        ...
        if (this.autoPlay) {
            this.startAutoplay(this.slideDuration);
        }
