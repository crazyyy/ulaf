...
Tags: content analysis, google search console, Readability, seo, images
...
[WP Image SEO](https://noorsplugin.com/wordpress-image-seo-plugin/) allows you to optimize your blog images. It automatically fills out the missing alt tags of your images.
...
For detailed documentation please visit the [WordPress Image SEO](https://noorsplugin.com/wordpress-image-seo-plugin/) plugin page

== Installation ==

1. Go to the Add New plugins screen in your WordPress admin area
1. Click the upload tab
1. Browse for the plugin file (wp-image-seo.zip)
...
For screenshots please visit the [WordPress Image SEO](https://noorsplugin.com/wordpress-image-seo-plugin/) plugin page
