 ...
 *
 * Checks if consent compliance is required based on availability.
 */
class AIPKit_Consent_IsRequiredChecker {
    ...
    /**
     * Checks if consent is required (Pro plan).
     *
    ...
    public static function check(): bool {
        ...
        // Consent is required for Pro builds (addon toggle removed).
