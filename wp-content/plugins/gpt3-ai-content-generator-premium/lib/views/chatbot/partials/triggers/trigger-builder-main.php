...
<div class="aipkit_trigger_builder_container" id="aipkit_trigger_builder_<?php echo esc_attr($bot_id); ?>" data-bot-id="<?php echo esc_attr($bot_id); ?>">
    ...
    <div class="aipkit_trigger_list_actions">
        <button type="button" class="aipkit_btn aipkit_btn-secondary aipkit_trigger_add_new_btn">
            ...
            <?php esc_html_e('Add New Rule', 'gpt3-ai-content-generator'); ?>
        </button>
    </div>

    <div class="aipkit_trigger_list_container" id="aipkit_trigger_list_for_<?php echo esc_attr($bot_id); ?>">
        <p
            class="aipkit_trigger_list_empty_message"
            data-empty-text="<?php echo esc_attr__('No rules configured yet. Click Add New Rule above to create one.', 'gpt3-ai-content-generator'); ?>"
            style="text-align:center; padding:15px; color: #777; font-style:italic;"
        >
            <?php
            ...
            if ($triggers_array === null || empty($triggers_array)) {
                esc_html_e('No rules configured yet. Click "Add New Rule" above to create one.', 'gpt3-ai-content-generator');
            } else {
                esc_html_e('Loading rules...', 'gpt3-ai-content-generator');
            }
            ?>
        </p>
    </div>
        ...
        <div class="aipkit_trigger_item">
            <div class="aipkit_trigger_item_header">
                ...
                <div class="aipkit_trigger_item_actions">
                    ...
                    <button type="button" class="aipkit_btn aipkit_btn-icon aipkit_trigger_edit_btn" title="<?php esc_attr_e('Edit Rule', 'gpt3-ai-content-generator'); ?>"><span class="dashicons dashicons-edit"></span></button>
                    <button type="button" class="aipkit_btn aipkit_btn-icon aipkit_trigger_delete_btn" title="<?php esc_attr_e('Delete Rule', 'gpt3-ai-content-generator'); ?>"><span class="dashicons dashicons-trash"></span></button>
                </div>
            </div>
