<?php
/**
 * Partial: Content Writer & AutoGPT Form - Google Sheets Input Mode (Shared)
 *
 * @since NEXT_VERSION
 */
    ...
    <div class="aipkit_gsheets_input_section" data-gsheets-input-zone>
        <div class="aipkit_gsheets_id_input_wrapper">
            <input
                ...
                placeholder="<?php esc_attr_e('Enter your Spreadsheet ID, e.g. 18QIWggMmbTVTb-nztTo7SFdGJTUC6kwRxgc841xq4x0', 'gpt3-ai-content-generator'); ?>"
            >
        ...
        <div class="aipkit_gsheets_upload_zone" data-gsheets-dropzone>
            <div class="aipkit_gsheets_upload_content">
                ...
                <div class="aipkit_gsheets_upload_text">
                    <span class="aipkit_gsheets_upload_primary"><?php esc_html_e('Upload your Google Cloud JSON key file', 'gpt3-ai-content-generator'); ?></span>
