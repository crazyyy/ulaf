    ...
    public function enqueue_assets($hook_suffix)
    {
        ...
        if (!$trigger_builder_localized && wp_script_is($lib_main_js_handle, 'enqueued')) {
            wp_localize_script($lib_main_js_handle, 'aipkit_trigger_builder_config', [
                ...
                'text' => [
                    'confirmDeleteTrigger' => __('Are you sure you want to delete this rule?', 'gpt3-ai-content-generator'),
                    'errorSaving' => __('Error saving rules.', 'gpt3-ai-content-generator'),
