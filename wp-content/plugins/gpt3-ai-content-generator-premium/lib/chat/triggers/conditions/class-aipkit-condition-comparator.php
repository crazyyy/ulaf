        ...
        switch ($operator) {
            ...
            case 'contains':
                if (is_array($actual_value)) {
                    if (is_string($expected_value) && $expected_value !== '') {
                        return in_array($expected_value, $actual_value, true);
                    }
                    if (is_array($expected_value) && !empty($expected_value)) {
            ...
            case 'not_contains':
                ...
                return false; // Invalid expected value should fail
            case 'starts_with':
