...
function process_chat_triggers(array $params): array {
    ...
    $http_referer        = isset($params['http_referer']) ? (string) $params['http_referer'] : '';
    $user_agent          = isset($params['user_agent']) ? (string) $params['user_agent'] : '';
    ...
    if (!$triggers_enabled || !class_exists($trigger_storage_class) || !class_exists($trigger_manager_class)) {
