...
return [
    ...
    'properties' => [
        'fields_by_type' => [
            'type' => 'object',
            'description' => 'Structured field lists keyed by condition type.',
            'additionalProperties' => true,
            'default' => [
                'user_context' => ['is_logged_in', 'user_role', 'user_message_text'],
                'text_content' => ['user_message_text'],
                'conversation_state' => ['message_count'],
                'ai_model_context' => ['current_provider', 'current_model_id'],
                'http_context' => ['http_referer', 'user_agent'],
                'post_context' => ['post_id', 'post_title', 'post_tags_contain'],
                'error_context' => ['error_code', 'error_message', 'failed_provider', 'failed_model', 'status_code', 'operation', 'module'],
            ],
        ],
        'type' => [
            'type' => 'string',
        ...
        'field' => [
            'type' => 'string',
            'description' => 'The specific field to evaluate within the chosen type. Examples: "is_logged_in", "user_role", "user_message_text", "message_count", "current_provider", "current_model_id", "http_referer", "user_agent", "post_id", "post_title", "post_tags_contain", "error_code", "error_message", "failed_provider", "failed_model", "status_code".',
            'required' => true,
        ],
        'operator' => [
            'type' => 'string',
