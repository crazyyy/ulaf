...
<div id="file_options_panel" 
        class="ctc-option-panel <?php $this->configured() ? '' : 'ctc-disable'; echo 'file_options' == $active_tab ? ' ctc-option-panel-active' : ''; ?>">
  ...
  <div class="ctc-input-row clearfix" id="input_row_screenshot">
      ...
      <div class="ctc-input-cell-wide"><?php
        include ( CHLD_THM_CFG_DIR . '/includes/views/zipform.php' ); 
      ?></div>
  </div>
