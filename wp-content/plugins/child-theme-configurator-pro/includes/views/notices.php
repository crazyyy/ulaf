...
?>
      <form action="" method="post">
        <?php $this->ctc()->fingerprint_field(); wp_nonce_field( apply_filters( 'chld_thm_cfg_action', 'ctc_update' ) ); ?>
  ...
  <form action="" method="post">
    <?php 
               $this->ctc()->fingerprint_field(); wp_nonce_field( apply_filters( 'chld_thm_cfg_action', 'ctc_update' ) ); ?>
  ...
  <?php
            ...
            case 'changed': ?>
  <p>
    <?php _e( 'The selected stylesheet has changed since the last time you used the Configurator. Please click "Update Settings" to refresh the data.', 'child-theme-configurator' ) ?>
  </p>
  <?php
                break;
