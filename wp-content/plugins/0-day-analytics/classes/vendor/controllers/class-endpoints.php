...
namespace ADVAN\Controllers\Api;
	...
	class Endpoints {
		...
		public static $endpoints = array(
			self::class => array(
					...
					'endpoints' => array(
						array(
							'(?P<table_name>\w+)/(?P<id>.+)/' => array(
								'methods'          => array(
									'method'   => \WP_REST_Server::READABLE,
									'callback' => 'extract_fatals_row_data',
								),
								'args'             => array(
									'table_name' => array(
										'required'    => true,
					...
					'endpoints' => array(
						array(
							'(?P<table_name>\w+)/(?P<id>.+)/' => array(
								'methods'          => array(
									'method'   => \WP_REST_Server::READABLE,
									'callback' => 'extract_hook_capture_row_data',
								),
								'args'             => array(
									'table_name' => array(
										'required'    => true,
									...
									'id'         => array(
										...
										'type'        => 'string',
										'pattern'     => '.+',
										'description' => 'ID of the hook capture record which row needs to be shown',
									),
								),
								'checkPermissions' => array( __CLASS__, 'check_permissions' ),
								'showInIndex'      => false,
				...
				'get_transient_record' => array(
					'class'     => Transients_Helper::class,
					'namespace' => self::ENDPOINT_ROOT_NAME . '/v1',

					'endpoints' => array(
						array(
							'(?P<transient_id>\d+)' => array(
								'methods'          => array(
									'method'   => \WP_REST_Server::READABLE,
									'callback' => 'get_transient_by_id',
								),
								'args'             => array(
									'transient_id' => array(
										'required'    => true,
					...
					'endpoints' => array(
						array(
							'get-status' => array(
								'methods'          => array(
									'method'   => \WP_REST_Server::READABLE,
									'callback' => 'rest_get_system_status',
								),
								'checkPermissions' => array( __CLASS__, 'check_permissions' ),
								'showInIndex'      => false,
							),
