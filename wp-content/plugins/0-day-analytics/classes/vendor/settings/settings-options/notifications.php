	...
	<?php
		...
		Settings::build_option(
			array(
				...
				'type'    => 'checkbox',
				'hint'    => \esc_html__( 'Enabling this will prevent plugin from sending notifications, but they will still be enabled for this site in this browser. IMPORTANT: Keep in mind that even if you disable notifications here, they may still be sent by from other tabs or browsers you have open - you need to refresh the page everywhere or close them.', '0-day-analytics' ),
