...
class LiqPayApi
{
    ...
    {        
        ...
        return sprintf('
            <form method="POST" action="%s" id="liqpayform" accept-charset="utf-8">
                %s
                %s
				<input type="submit" class="button-alt button" id="submit_dibs_payment_form" name="btn_text" value="' . __('Pay', 'woocommerce') . '" style="float: left; margin-right: 23px;margin-top: 0 !important;" />
            </form>
            ',
            $this->_checkout_url,
