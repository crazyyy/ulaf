...
if ( !class_exists( 'MeowKit_MWCODE_Admin' ) ) {

  class MeowKit_MWCODE_Admin {
    ...
    public function admin_menu_start() {
      ...
      if ( !isset( $submenu[ 'meowapps-main-menu' ] ) ) {
        add_menu_page(
          'Meow Apps',
          '<img alt="Meow Apps" style="width: 21px; margin-left: -28px; position: absolute; margin-top: 2px;" src="' . MeowKit_MWCODE_Admin::$logo . '" />Meow Apps',
          'manage_options',
          'meowapps-main-menu',
