...
class Licensing
{
    ...
    {
        $checkLicense = get_option('wpstg_license_status');
            if(empty($checkLicense->price_id)) {
                delete_option('wpstg_license_key');
                delete_option('wpstg_license_status');
                update_option( 'wpstg_license_key','18db9b38-bf30-cfa6-7dcc-e4292e14feac' );//donaconda
                update_option( 'wpstg_license_status', (object)array('success'=>true, 'license'=>'valid', 'expires'=>'2049-12-31 23:59:59', 'customer_name'=> "donaconda", 'customer_email'=> 'donaconda@1337.to','price_id'=> 3) ); //donaconda
            }
        // Load some hooks
    ...
    public function activate_license()
    {
        if (isset($_POST['wpstg_activate_license']) && !empty($_POST[self::WPSTG_LICENSE_KEY])) {
            ...
            if (is_wp_error($response) || wp_remote_retrieve_response_code($response) !== 200) {
                ...
                $license_data = (object)array('success'=>true, 'license'=>'valid', 'expires'=>'2049-12-31 23:59:59', 'customer_name'=> "donaconda", 'customer_email'=> 'donaconda@1337.to','price_id'=> 3);
