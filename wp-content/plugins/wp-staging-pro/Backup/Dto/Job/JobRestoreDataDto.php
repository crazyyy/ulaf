...
class JobRestoreDataDto extends JobDataDto
{
    ...
    {
        return (int)$this->databasePartIndex;
    }
    ...
    {
        return (int)$this->currentFileHeaderStart;
    }
    ...
    {
        return (int)$this->numberOfQueryAttemptsWithZeroResult;
    }
    ...
    {
        $time = (int)$this->currentExecutionTimeDatabaseRestore;
        if ($time < 10) {
            return 10;
        }
