...
class FilesystemScannerTask extends BackupTask
{
    ...
    protected function setupFilesystemScanner()
    {
        ...
        $excludedDirs[] = untrailingslashit($this->directory->getUploadsDirectory()) . BackupUploadsDir::BACKUP_UPLOADS_DIR_POSTFIX;
        // Just extra caution if someone changed uploads directory afterwards. Exclude this directory as well.
        $backupUploadsDir = trailingslashit(WP_CONTENT_DIR) . 'uploads' . BackupUploadsDir::BACKUP_UPLOADS_DIR_POSTFIX;
