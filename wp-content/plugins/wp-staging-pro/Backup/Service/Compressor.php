...
class Compressor
{
    ...
    private function updateIndexInformationForAlreadyAddedIndex($writtenBytesTotal)
    {
        ...
        if (count($lastLine) !== 1) {
            debug_log('Failed to read backup metadata file index information. Error: The last line is not an array or element with countable interface. Last line: ' . $lastLine);
