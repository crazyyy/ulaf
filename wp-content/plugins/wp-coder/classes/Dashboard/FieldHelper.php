...
class FieldHelper {
	...
	public static function gtranslate(): array {
		return [
			'af'  => esc_attr__( 'Afrikaans', 'wp-coder' ),
			'sq'  => esc_attr__( 'Albanian', 'wp-coder' ),
			'am'  => esc_attr__( 'Amharic', 'wp-coder' ),
			'ar'  => esc_attr__( 'Arabic', 'wp-coder' ),
			'hy'  => esc_attr__( 'Armenian', 'wp-coder' ),
			'az'  => esc_attr__( 'Azerbaijani', 'wp-coder' ),
			'eu'  => esc_attr__( 'Basque', 'wp-coder' ),
			'be'  => esc_attr__( 'Belarusian', 'wp-coder' ),
			'bn'  => esc_attr__( 'Bengali', 'wp-coder' ),
			'bs'  => esc_attr__( 'Bosnian', 'wp-coder' ),
			'bg'  => esc_attr__( 'Bulgarian', 'wp-coder' ),
			'ca'  => esc_attr__( 'Catalan', 'wp-coder' ),
			'ceb' => esc_attr__( 'Cebuano', 'wp-coder' ),
			'ny'  => esc_attr__( 'Chichewa', 'wp-coder' ),
			'co'  => esc_attr__( 'Corsican', 'wp-coder' ),
			'hr'  => esc_attr__( 'Croatian', 'wp-coder' ),
			'cs'  => esc_attr__( 'Czech', 'wp-coder' ),
			'da'  => esc_attr__( 'Danish', 'wp-coder' ),
			'nl'  => esc_attr__( 'Dutch', 'wp-coder' ),
			'en'  => esc_attr__( 'English', 'wp-coder' ),
			'eo'  => esc_attr__( 'Esperanto', 'wp-coder' ),
			'et'  => esc_attr__( 'Estonian', 'wp-coder' ),
			'tl'  => esc_attr__( 'Filipino', 'wp-coder' ),
			'fi'  => esc_attr__( 'Finnish', 'wp-coder' ),
			'fr'  => esc_attr__( 'French', 'wp-coder' ),
			'fy'  => esc_attr__( 'Frisian', 'wp-coder' ),
			'gl'  => esc_attr__( 'Galician', 'wp-coder' ),
			'ka'  => esc_attr__( 'Georgian', 'wp-coder' ),
			'de'  => esc_attr__( 'German', 'wp-coder' ),
			'el'  => esc_attr__( 'Greek', 'wp-coder' ),
			'gu'  => esc_attr__( 'Gujarati', 'wp-coder' ),
			'ht'  => esc_attr__( 'Haitian Creole', 'wp-coder' ),
			'ha'  => esc_attr__( 'Hausa', 'wp-coder' ),
			'haw' => esc_attr__( 'Hawaiian', 'wp-coder' ),
			'iw'  => esc_attr__( 'Hebrew', 'wp-coder' ),
			'hi'  => esc_attr__( 'Hindi', 'wp-coder' ),
			'hmn' => esc_attr__( 'Hmong', 'wp-coder' ),
			'hu'  => esc_attr__( 'Hungarian', 'wp-coder' ),
			'is'  => esc_attr__( 'Icelandic', 'wp-coder' ),
			'ig'  => esc_attr__( 'Igbo', 'wp-coder' ),
			'id'  => esc_attr__( 'Indonesian', 'wp-coder' ),
			'ga'  => esc_attr__( 'Irish', 'wp-coder' ),
			'it'  => esc_attr__( 'Italian', 'wp-coder' ),
			'ja'  => esc_attr__( 'Japanese', 'wp-coder' ),
			'jw'  => esc_attr__( 'Javanese', 'wp-coder' ),
			'kn'  => esc_attr__( 'Kannada', 'wp-coder' ),
			'kk'  => esc_attr__( 'Kazakh', 'wp-coder' ),
			'km'  => esc_attr__( 'Khmer', 'wp-coder' ),
			'ko'  => esc_attr__( 'Korean', 'wp-coder' ),
			'ku'  => esc_attr__( 'Kurdish (Kurmanji)', 'wp-coder' ),
			'ky'  => esc_attr__( 'Kyrgyz', 'wp-coder' ),
			'lo'  => esc_attr__( 'Lao', 'wp-coder' ),
			'la'  => esc_attr__( 'Latin', 'wp-coder' ),
			'lv'  => esc_attr__( 'Latvian', 'wp-coder' ),
			'lb'  => esc_attr__( 'Luxembourgish', 'wp-coder' ),
			'mk'  => esc_attr__( 'Macedonian', 'wp-coder' ),
			'mg'  => esc_attr__( 'Malagasy', 'wp-coder' ),
			'ms'  => esc_attr__( 'Malay', 'wp-coder' ),
			'ml'  => esc_attr__( 'Malayalam', 'wp-coder' ),
			'mt'  => esc_attr__( 'Maltese', 'wp-coder' ),
			'mi'  => esc_attr__( 'Maori', 'wp-coder' ),
			'mr'  => esc_attr__( 'Marathi', 'wp-coder' ),
			'mn'  => esc_attr__( 'Mongolian', 'wp-coder' ),
			'my'  => esc_attr__( 'Myanmar (Burmese)', 'wp-coder' ),
			'ne'  => esc_attr__( 'Nepali', 'wp-coder' ),
			'no'  => esc_attr__( 'Norwegian', 'wp-coder' ),
			'ps'  => esc_attr__( 'Pashto', 'wp-coder' ),
			'fa'  => esc_attr__( 'Persian', 'wp-coder' ),
			'pl'  => esc_attr__( 'Polish', 'wp-coder' ),
			'pt'  => esc_attr__( 'Portuguese', 'wp-coder' ),
			'pa'  => esc_attr__( 'Punjabi', 'wp-coder' ),
			'ro'  => esc_attr__( 'Romanian', 'wp-coder' ),
			'ru'  => esc_attr__( 'Russian', 'wp-coder' ),
			'sm'  => esc_attr__( 'Samoan', 'wp-coder' ),
			'gd'  => esc_attr__( 'Scottish Gaelic', 'wp-coder' ),
			'sr'  => esc_attr__( 'Serbian', 'wp-coder' ),
			'st'  => esc_attr__( 'Sesotho', 'wp-coder' ),
			'sn'  => esc_attr__( 'Shona', 'wp-coder' ),
			'sd'  => esc_attr__( 'Sindhi', 'wp-coder' ),
			'si'  => esc_attr__( 'Sinhala', 'wp-coder' ),
			'sk'  => esc_attr__( 'Slovak', 'wp-coder' ),
			'sl'  => esc_attr__( 'Slovenian', 'wp-coder' ),
			'so'  => esc_attr__( 'Somali', 'wp-coder' ),
			'es'  => esc_attr__( 'Spanish', 'wp-coder' ),
			'su'  => esc_attr__( 'Sudanese', 'wp-coder' ),
			'sw'  => esc_attr__( 'Swahili', 'wp-coder' ),
			'sv'  => esc_attr__( 'Swedish', 'wp-coder' ),
			'tg'  => esc_attr__( 'Tajik', 'wp-coder' ),
			'ta'  => esc_attr__( 'Tamil', 'wp-coder' ),
			'te'  => esc_attr__( 'Telugu', 'wp-coder' ),
			'th'  => esc_attr__( 'Thai', 'wp-coder' ),
			'tr'  => esc_attr__( 'Turkish', 'wp-coder' ),
			'uk'  => esc_attr__( 'Ukrainian', 'wp-coder' ),
			'ur'  => esc_attr__( 'Urdu', 'wp-coder' ),
			'uz'  => esc_attr__( 'Uzbek', 'wp-coder' ),
			'vi'  => esc_attr__( 'Vietnamese', 'wp-coder' ),
			'cy'  => esc_attr__( 'Welsh', 'wp-coder' ),
			'xh'  => esc_attr__( 'Xhosa', 'wp-coder' ),
			'yi'  => esc_attr__( 'Yiddish', 'wp-coder' ),
			'yo'  => esc_attr__( 'Yoruba', 'wp-coder' ),
			'zu'  => esc_attr__( 'Zulu', 'wp-coder' ),
		];
	}

	public static function share_services() {
		return [
			'facebook'         => __( 'Facebook', 'wp-coder' ),
			'vk'               => __( 'VK', 'wp-coder' ),
			'twitter'          => __( 'Twitter', 'wp-coder' ),
			'linkedin'         => __( 'Linkedin', 'wp-coder' ),
			'odnoklassniki'    => __( 'Odnoklassniki', 'wp-coder' ),
			'google'           => __( 'Google', 'wp-coder' ),
			'pinterest'        => __( 'Pinterest', 'wp-coder' ),
			'xing'             => __( 'XING', 'wp-coder' ),
			'myspace'          => __( 'Myspace', 'wp-coder' ),
			'weibo'            => __( 'Weibo', 'wp-coder' ),
			'buffer'           => __( 'Buffer', 'wp-coder' ),
			'stumbleupon'      => __( 'StumbleUpon', 'wp-coder' ),
			'reddit'           => __( 'Reddit', 'wp-coder' ),
			'tumblr'           => __( 'Tumblr', 'wp-coder' ),
			'blogger'          => __( 'Blogger', 'wp-coder' ),
			'livejournal'      => __( 'LiveJournal', 'wp-coder' ),
			'pocket'           => __( 'Pocket', 'wp-coder' ),
			'telegram'         => __( 'Telegram', 'wp-coder' ),
			'skype'            => __( 'Skype', 'wp-coder' ),
			'email'            => __( 'Email', 'wp-coder' ),
			'draugiem'         => __( 'Draugiem', 'wp-coder' ),
			'whatsapp'         => __( 'Whatsapp', 'wp-coder' ),
			'diaspora'         => __( 'Diaspora', 'wp-coder' ),
			'digg'             => __( 'Digg', 'wp-coder' ),
			'douban'           => __( 'Douban', 'wp-coder' ),
			'evernote'         => __( 'Evernote', 'wp-coder' ),
			'flipboard'        => __( 'Flipboard', 'wp-coder' ),
			'google-bookmarks' => __( 'Google Bookmarks', 'wp-coder' ),
			'hacker-news'      => __( 'Hacker News', 'wp-coder' ),
			'instapaper'       => __( 'Instapaper', 'wp-coder' ),
			'line'             => __( 'Line', 'wp-coder' ),
			'qzone'            => __( 'Qzone', 'wp-coder' ),
			'renren'           => __( 'Renren', 'wp-coder' ),
		];
	}
	...
	public static function icon_type() {
		return [
			'default' => __( 'Default', 'wp-coder' ),
			'img'     => __( 'Image', 'wp-coder' ),
			'emoji'   => __( 'Emoji', 'wp-coder' ),
			'class'   => __( 'Icon Class', 'wp-coder' ),
		];
	}

	public static function btn_position() {
		return [
			'flBtn-position-br' => __( 'bottom-right', 'wp-coder' ),
			'flBtn-position-bl' => __( 'bottom-left', 'wp-coder' ),
			'flBtn-position-b'  => __( 'bottom-center', 'wp-coder' ),
			'flBtn-position-tr' => __( 'top-right', 'wp-coder' ),
			'flBtn-position-tl' => __( 'top-left', 'wp-coder' ),
			'flBtn-position-t'  => __( 'top-center', 'wp-coder' ),
			'flBtn-position-l'  => __( 'left', 'wp-coder' ),
			'flBtn-position-r'  => __( 'right', 'wp-coder' ),
		];
	}

	public static function btn_shape() {
		return [
			'flBtn-shape-circle'  => __( 'Circle', 'wp-coder' ),
			'flBtn-shape-ellipse' => __( 'Ellipse', 'wp-coder' ),
			'flBtn-shape-square'  => __( 'Square', 'wp-coder' ),
			'flBtn-shape-rsquare' => __( 'Rounded square', 'wp-coder' ),
		];
	}

	public static function btn_size() {
		return [
			'flBtn-size-small'  => __( 'Small', 'wp-coder' ),
			'flBtn-size-medium' => __( 'Medium', 'wp-coder' ),
			'flBtn-size-large'  => __( 'Large', 'wp-coder' ),
			'flBtn-custom'      => __( 'Custom', 'wp-coder' ),
		];
	}
	...
	public static function btn_self_animation() {
		return [
			''                 => __( 'None', 'wp-coder' ),
			'flBtn-bounce'     => __( 'Bounce', 'wp-coder' ),
			'flBtn-flash'      => __( 'Flash', 'wp-coder' ),
			'flBtn-pulse'      => __( 'pulse', 'wp-coder' ),
			'flBtn-rubberBand' => __( 'rubberBand', 'wp-coder' ),
			'flBtn-shake'      => __( 'shake', 'wp-coder' ),
			'flBtn-headShake'  => __( 'headShake', 'wp-coder' ),
			'flBtn-swing'      => __( 'swing', 'wp-coder' ),
			'flBtn-tada'       => __( 'tada', 'wp-coder' ),
			'flBtn-wobble'     => __( 'wobble', 'wp-coder' ),
			'flBtn-jello'      => __( 'jello', 'wp-coder' ),
			'flBtn-heartBeat'  => __( 'heartBeat', 'wp-coder' ),
		];
	}
	...
	public static function btn_animation() {
		return [
			''                                    => __( 'Fade', 'wp-coder' ),
			'flBtn-effect-rotate'                 => __( 'Rotate', 'wp-coder' ),
			'flBtn-effect-scale'                  => __( 'Scale', 'wp-coder' ),
			'flBtn-effect-rotate-scale'           => __( 'Rotate and Scale', 'wp-coder' ),
			'flBtn-effect-translate'              => __( 'Translate', 'wp-coder' ),
			'flBtn-effect-rotate-translate'       => __( 'Translate Rotate', 'wp-coder' ),
			'flBtn-effect-rotate-translate-scale' => __( 'Rotate Translate Scale', 'wp-coder' ),
			'flBtn-effect-translate-scale'        => __( 'Translate Scale', 'wp-coder' ),
		];
	}
	...
	public static function user_roles(): array {
		$add_users      = array( 'all' => array( 'name' => __( 'All Users', 'wp-coder' ) ) );
