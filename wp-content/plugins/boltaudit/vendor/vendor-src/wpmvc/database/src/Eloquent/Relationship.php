...
namespace BoltAudit\WpMVC\Database\Eloquent;

\defined("ABSPATH") || exit;
use BoltAudit\WpMVC\Database\Eloquent\Relations\BelongsToMany;
use BoltAudit\WpMVC\Database\Eloquent\Relations\BelongsToOne;
use BoltAudit\WpMVC\Database\Eloquent\Relations\HasOne;
use BoltAudit\WpMVC\Database\Eloquent\Relations\Relation;
use BoltAudit\WpMVC\Database\Query\Builder;
use wpdb;
class Relationship
{
