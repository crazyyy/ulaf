...
namespace BoltAudit\WpMVC;

\defined('ABSPATH') || exit;
use BoltAudit\DI\Container;
use BoltAudit\WpMVC\Contracts\Provider;
use BoltAudit\WpMVC\Providers\EnqueueServiceProvider;
use BoltAudit\WpMVC\Providers\MigrationServiceProvider;
use BoltAudit\WpMVC\Providers\RouteServiceProvider;
class App
{
