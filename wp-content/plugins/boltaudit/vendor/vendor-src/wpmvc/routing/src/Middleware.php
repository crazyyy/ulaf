...
namespace BoltAudit\WpMVC\Routing;

\defined('ABSPATH') || exit;
use BoltAudit\WpMVC\Routing\Providers\RouteServiceProvider;
use BoltAudit\WpMVC\Routing\Contracts\Middleware as MiddlewareContract;
use WP_Error;
class Middleware
{
