...
namespace BoltAudit\DI\Proxy;

use BoltAudit\ProxyManager\Configuration;
use BoltAudit\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use BoltAudit\ProxyManager\FileLocator\FileLocator;
use BoltAudit\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use BoltAudit\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use BoltAudit\ProxyManager\Proxy\LazyLoadingInterface;
/**
