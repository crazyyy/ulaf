...
namespace BoltAudit\DI\Compiler;

use function chmod;
use BoltAudit\DI\Definition\ArrayDefinition;
use BoltAudit\DI\Definition\DecoratorDefinition;
...
use BoltAudit\DI\Definition\Source\DefinitionSource;
use BoltAudit\DI\Definition\StringDefinition;
use BoltAudit\DI\Definition\ValueDefinition;
use BoltAudit\DI\DependencyException;
use BoltAudit\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use BoltAudit\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
