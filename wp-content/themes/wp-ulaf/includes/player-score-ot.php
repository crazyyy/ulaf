...
<div class="col-md-12 inner player-position-ot">
    <h4>player stats as OT</h4>
    <table class="player-score player-score-ot">
        <tr>
            <th><img src="<?php echo get_template_directory_uri(); ?>/img/logo.png"></th>
                  <?php
                  // check if the repeater field has rows of data
                  if( have_rows('player_ot') ):
                    // loop through the rows of data
                      while ( have_rows('player_ot') ) : the_row(); ?>
            <th>
