<?php
  ...
  /**
   * Register a custom Gutenberg block type: About Block.
   * This function registers a custom Gutenberg block type called "About Block".
   ...
   */
  function register_block_about() {
    acf_register_block_type(array(
      'name' => 'wpeb-about-block',
      'title' => __('About Block', 'wpeb'),
      'description' => __('About Block Description', 'wpeb'),
      ...
      'render_template' => 'blocks/about-block/block.php',
      'enqueue_style' => WPEB_TEMPLATE_URL . '/blocks/about-block/styles.css',
      'enqueue_script' => WPEB_TEMPLATE_URL . '/blocks/about-block/scripts.js',
      'supports' => array(
        'anchor' => true,
        'align' => true,
        'align_text' => false,
  ...
  add_action('acf/init', 'register_block_about');
