    ...
    <div class="clearfix">
        <?php if(!empty($title)): ?>
            <div class="stm-title-left">
                <h2 style="position: relative;" class="stm-main-title-unit white"><?php echo esc_attr($title); ?></h2>
            </div>
        <?php endif; ?>
    </div>
                        ...
                        $metrics = (array)get_post_meta( $post_id, 'sp_metrics', true );
                            ...
                            if($statistics != null):
                                ...
                                if(!empty($player_image_id)) {
                                    $image = splash_get_thumbnail_url( 0, $player_image_id, 'stm-445-445' );
                                } else {
                                    $image = '';
                                }
                                                ...
                                                <div class="stm-custom-row">
                                                    ...
                                                    <div class="col-43">
                                                        <div class="stm-quick-sts heading-font">
                                                            <?php echo esc_html_e('Quick stats', 'splash') . " (" . esc_html($seasonName) . ")"; ?>
                                                        </div>
                                                        <div class="stm-metric-wrapp">
                                                            <table class="stm-metric">
                                                                <tbody>
                                                                        ...
                                                                        if(in_array($k, $equations)) {
                                                                            if ($val != 0 && $val != "" && $val != "-" && $k != "name" && $k != "team"):
                                                                                ...
                                                                                <tr class="<?php if ($q % 2 == 0) echo "odd"; else echo "even"; ?>">
                                                                                    <td>
                                                                                            <span
                                                                                                class="stm-metric-title normal_font"><?php echo esc_html($params[$k]); ?></span>
                                                                                    </td>
                                                                                    <td>
                                                                                        <span class="stm-metric-data normal_font"><?php echo esc_html($val); ?></span>
                                                                                    </td>
