...
if(is_singular('post') && splash_is_layout('magazine_two') && get_post_thumbnail_id(get_the_id())){
	$header_background = get_the_post_thumbnail_url(get_the_id());
}
if(is_singular('post') && splash_is_layout('soccer_news') && get_post_thumbnail_id(get_the_id())){
    $header_background = get_the_post_thumbnail_url(get_the_id());
}
?>
