...
<?php if(!empty($langs)): ?>
	...
	<div class="language-switcher-unit <?php echo (splash_is_layout("bb")) ? "heading-font" : "normal_font"; ?>">
		<div class="stm-current-language <?php echo esc_attr($langs_exist); ?>" <?php if(count($langs) > 1){ ?> id="lang_dropdown_mobile" data-toggle="dropdown" <?php } ?>>
			...
			<span class="stm-language-code"><?php echo esc_attr(ICL_LANGUAGE_CODE); ?></span>
					...
					<?php if(!$lang['active']): ?>
						<li role="presentation">
							<a role="menuitem" tabindex="-1" href="<?php echo esc_url($lang['url']); ?>">
								<span class="stm-language-flag"><img src="<?php echo esc_url($lang['country_flag_url']); ?>" alt="<?php echo esc_attr($lang['language_code']); ?>" /></span>
								<span class="stm-language-code"><?php echo esc_attr($lang['language_code']); ?></span>
							</a>
						</li>
					<?php endif; ?>
				<?php endforeach; ?>
