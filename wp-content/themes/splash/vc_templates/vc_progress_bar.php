...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<span class="vc_bar ' . esc_attr( implode( ' ', $bar_options ) ) . '" data-percentage-value="' . esc_attr( $percentage_value ) . '" data-value="' . esc_attr( $line['value'] ) . '"' . $line['bgcolor'] . '><small>' . esc_attr( $percentage_value ) . '%</small></span>';
	$output .= '</div>';
}
