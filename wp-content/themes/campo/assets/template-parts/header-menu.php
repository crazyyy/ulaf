...
?>
	...
	<header id="masthead" class="site-header" style="<?php echo esc_attr( $site_header_style_attr ); ?>">
		...
		<!-- Crest enabled -->
		<?php if ( boldthemes_get_option( 'crest_logo' ) || is_customize_preview() ) { ?>
			<!-- .site-header-inner-wrapper -->
			<div class="site-header-wrapper"><div class="site-header-wrapper-inner">
				<div class="site-header-inner-left" style="<?php echo esc_attr( $site_branding_style_attr ); ?>">
					<?php
						echo ( boldthemes_logo( 'crest_logo' ) );
					?>
				</div>
