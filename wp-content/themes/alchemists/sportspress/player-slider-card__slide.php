...
if( $player_image_head ) {
	...
	$image_url = '<img src="' . get_theme_file_uri( '/assets/images/player-single-370x400.png' ) . '" alt="" />';
}
		...
		echo '<div class="team-roster__content-wrapper">';
			...
			echo '<div class="team-roster__content">';
				...
				echo '<div class="team-roster__player-excerpt">';
					echo wp_kses_post( $player_excerpt );
				echo '</div>';
				...
				echo '<div class="team-roster__player-stats">';
					...
					if ( !empty( $shpercent )) :
						echo '<div class="progress-stats mb-20">';
							echo '<div class="progress__label progress__label--color-default">' . esc_html__( 'Shot Accuracy', 'alchemists' ) .'</div>';
					...
					if ( !empty( $passpercent )) :
						echo '<div class="progress-stats mb-20">';
							echo '<div class="progress__label progress__label--color-default">' . esc_html__( 'Pass Accuracy', 'alchemists' ) .'</div>';
							echo '<div class="progress">';
					...
					if ( !empty( $performance )) :
						echo '<div class="progress-stats mb-20">';
							echo '<div class="progress__label progress__label--color-default">' . esc_html__( 'Performance', 'alchemists' ) .'</div>';
							echo '<div class="progress">';
				...
				echo '<footer class="team-roster__player-footer">';
					echo '<a href="' . get_permalink( $id ) . '" class="btn btn-primary-inverse">' . esc_html__( 'Read Full Bio', 'alchemists' ) . '</a>';
				echo '</footer>';
