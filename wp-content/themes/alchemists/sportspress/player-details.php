...
if ( $show_name ):
	$common[ esc_attr__( 'Name', 'alchemists' ) ] = $player->post->post_title;
endif;
...
if ( $show_nationality ) :
	...
	if ( $nationalities && is_array( $nationalities ) ) :
		...
		endforeach;
		$common[ esc_attr__( 'Nationality', 'alchemists' ) ] = implode( '<br>', $values );
	endif;
endif;
...
if ( $show_positions ) :
	...
	if ( $positions && is_array( $positions ) ) :
		...
		endforeach;
		$common[ esc_attr__( 'Position', 'alchemists' ) ] = implode( ', ', $position_names );
	endif;
endif;
...
if ( $show_current_teams ) :
	...
	if ( $current_teams ) :
		...
		foreach ( $current_teams as $team ) :
			...
			$teams[] = $team_name;
		endforeach;
		$data[ esc_attr__( 'Current Team', 'alchemists' ) ] = implode( ', ', $teams );
	endif;
endif;
...
if ( $show_past_teams ) :
	...
	if ( $past_teams ) :
		...
		foreach ( $past_teams as $team ) :
			...
			$teams[] = $team_name;
		endforeach;
		$data[ esc_attr__( 'Past Teams', 'alchemists' ) ] = implode( ', ', $teams );
	endif;
endif;
...
if ( $show_leagues ) :
	...
	if ( $leagues && ! is_wp_error( $leagues ) ) :
		...
		$data[ esc_attr__( 'Leagues', 'alchemists' ) ] = implode( ', ', $terms );
	endif;
endif;
...
if ( $show_seasons ) :
	...
	if ( $seasons && ! is_wp_error( $seasons ) ) :
		...
		$data[ esc_attr__( 'Seasons', 'alchemists' ) ] = implode( ', ', $terms );
	endif;
endif;
