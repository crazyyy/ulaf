...
{
    case 'photo':
        if($simpla->managers->access('photos'))
            $result = $simpla->photos->update_photo($id, $values);
        break;
    case 'photos_category':
        if($simpla->managers->access('photos'))
            $result = $simpla->photos->update_category($id, $values);
        break;
    case 'article':
    ...
    case 'menu_group':
        if($simpla->managers->access('dmenus'))
            $result = $simpla->dmenus->update_menu_group($id, $values);
        break;
    case 'dmenu':
        if($simpla->managers->access('dmenus'))
