<?php /* Smarty version Smarty-3.1.18, created on 2016-03-09 20:43:03
         compiled from "simpla/design/html/products.tpl" */ ?>
<?php /*%%SmartyHeaderCode:62251112756df68cb8bfc94-71296936%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '62251112756df68cb8bfc94-71296936',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_56df68cba55489_76645867',
  'variables' => 
  array (
    'manager' => 0,
    'category' => 0,
...
<?php if ($_valid && !is_callable('content_56df68cba55489_76645867')) {function content_56df68cba55489_76645867($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/ulafuacom/data/www/ulafua.com/Smarty/libs/plugins/modifier.truncate.php';
?>
...
<?php } else { ?>
	<?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable('Игроки', null, 1);
if ($_smarty_tpl->parent != null) $_smarty_tpl->parent->tpl_vars['meta_title'] = clone $_smarty_tpl->tpl_vars['meta_title'];?>
<?php }?>
...
<div id="header">	
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->tpl_vars['products_count']->value,'игрок','игроков','игрока');?>
</h1>
		<?php }?>		
	<?php } else { ?>
		<h1>Нет игроков</h1>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
			...
			<div class="icons cell">
				<a class="preview"   title="Предпросмотр в новом окне" href="../players/<?php echo $_smarty_tpl->tpl_vars['product']->value->url;?>
" target="_blank"></a>			
		...
		<div id="action">
			...
			<select name="action">
				...
				<option value="move_to_category">Переместить в команду</option>
				<?php }?>
