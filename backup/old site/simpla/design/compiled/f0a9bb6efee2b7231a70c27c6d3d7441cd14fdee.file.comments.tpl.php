<?php /* Smarty version Smarty-3.1.18, created on 2016-03-13 00:10:00
         compiled from "simpla/design/html/comments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:137654452856e493b8a75275-19349055%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '137654452856e493b8a75275-19349055',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e493b8b39b49_67896747',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e493b8b39b49_67896747')) {function content_56e493b8b39b49_67896747($_smarty_tpl) {?>
...
<div id="header">
 ...
 к записям в блоге</h1>
    <?php } elseif ($_smarty_tpl->tpl_vars['type']->value=='article') {?>
        <h1><?php echo $_smarty_tpl->tpl_vars['comments_count']->value;?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->tpl_vars['comments_count']->value,'комментарий','комментариев','комментария');?>
 к статьям</h1>
	<?php }?>
...
/players/<?php echo $_smarty_tpl->tpl_vars['comment']->value->product->url;?>
...
"><?php echo $_smarty_tpl->tpl_vars['comment']->value->post->name;?>
                    ...
                    <?php } elseif ($_smarty_tpl->tpl_vars['comment']->value->type=='article') {?>
                        к статье <a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['config']->value->root_url;?>
/article/<?php echo $_smarty_tpl->tpl_vars['comment']->value->article->url;?>
#comment_<?php echo $_smarty_tpl->tpl_vars['comment']->value->id;?>
"><?php echo $_smarty_tpl->tpl_vars['comment']->value->article->name;?>
</a>
					<?php }?>
					</div>
				</div>
...
'>К блогу</a></li>
        <li <?php if ($_smarty_tpl->tpl_vars['type']->value=='article') {?>class="selected"<?php }?>><a href='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('keyword'=>null,'type'=>'article'),$_smarty_tpl);?>
'>К статьям</a></li>
