<?php /* Smarty version Smarty-3.1.18, created on 2016-03-09 06:57:36
         compiled from "simpla/design/html/settings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:72104627956dfad401156e2-70901639%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '72104627956dfad401156e2-70901639',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56dfad401c85c2_44661037',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56dfad401c85c2_44661037')) {function content_56dfad401c85c2_44661037($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/ulafuacom/data/www/ulafua.com/Smarty/libs/plugins/function.math.php';
...
" /></li>
    ...
    <div class="block layer">
        ...
        <ul>
            <li><label class=property>Фотографий на странице сайта</label><input name="photos_num" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->photos_num, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
            <li><label class=property>Фотографий на странице админки</label><input name="photos_num_admin" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->photos_num_admin, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
        </ul>
    </div>
