<?php /* Smarty version Smarty-3.1.18, created on 2016-03-13 03:19:16
         compiled from "simpla/design/html/category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9179565556e06ef957a360-97812166%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '9179565556e06ef957a360-97812166',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_56e06ef965ae62_92016563',
  'variables' => 
  array (
    'manager' => 0,
    'category' => 0,
...
<?php if ($_valid && !is_callable('content_56e06ef965ae62_92016563')) {function content_56e06ef965ae62_92016563($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/ulafuacom/data/www/ulafua.com/Smarty/libs/plugins/modifier.replace.php';
?>
<?php $_smarty_tpl->_capture_stack[0][] = array('tabs', null, null); ob_start(); ?>
	<?php if (in_array('products',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?><li><a href="index.php?module=ProductsAdmin">Игроки</a></li><?php }?>
	<li class="active"><a href="index.php?module=CategoriesAdmin">Команды</a></li>
	<?php if (in_array('brands',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?><li><a href="index.php?module=BrandsAdmin">Спонсоры</a></li><?php }?>
...
<div class="message message_success">
	<span class="text"><?php if ($_smarty_tpl->tpl_vars['message_success']->value=='added') {?>Команда добавлена<?php } elseif ($_smarty_tpl->tpl_vars['message_success']->value=='updated') {?>Команда  обновлена<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['message_success']->value;?>
<?php }?></span>
	<a class="link" target="_blank" href="../teams/<?php echo $_smarty_tpl->tpl_vars['category']->value->url;?>
">Открыть команду на сайте</a>
	<?php if ($_GET['return']) {?>
...
/teams/<?php echo urlencode($_smarty_tpl->tpl_vars['category']->value->url);?>
...
<div class="message message_error">
	<span class="text"><?php if ($_smarty_tpl->tpl_vars['message_error']->value=='url_exists') {?>Команда с таким адресом уже существует<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['message_error']->value;?>
<?php }?></span>
...
"/> 
		<div class="checkbox">
			...
			<input name=visible_logo value='1' type="checkbox" id="visible_logo" <?php if ($_smarty_tpl->tpl_vars['category']->value->visible_logo) {?>checked<?php }?>/> <label for="visible_logo">Отображать лого</label>
		</div>
	</div> 
...
foreach (Smarty::$global_tpl_vars as $key => $value) if(!isset($_smarty_tpl->tpl_vars[$key])) $_smarty_tpl->tpl_vars[$key] = $value;}}?>
	...
	<div id="column_left">
		...
		<div class="block layer">
			...
			<ul>
				<li><label class=property>Адрес</label><div class="page_url">/teams/</div><input name="url" class="page_url" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->url, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
                <li><label class=property>Город</label><input name="city" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->city, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
                <li><label class=property>Президент</label><input name="head" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->head, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
                <li><label class=property>Тренеры</label><input name="coach" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->coach, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
                <li><label class=property>Создан</label><input name="create_club" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->create_club, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
                <li><label class=property>Сайт</label><input name="site" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->site, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
...
'>
                    <div class="info">
                        <input name="fios[]" value="<?php echo $_smarty_tpl->tpl_vars['image']->value->fio;?>
" placeholder="ФИО"/>
                        <input name="pos_in_foto[]" value="<?php echo $_smarty_tpl->tpl_vars['image']->value->pos_in_foto;?>
