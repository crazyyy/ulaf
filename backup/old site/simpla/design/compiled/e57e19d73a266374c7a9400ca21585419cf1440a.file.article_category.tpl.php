<?php /* Smarty version Smarty-3.1.18, created on 2016-03-13 02:41:43
         compiled from "simpla/design/html/article_category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:80382970756e4b747b228c4-64718561%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e57e19d73a266374c7a9400ca21585419cf1440a' => 
    array (
      0 => 'simpla/design/html/article_category.tpl',
      1 => 1420800042,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '80382970756e4b747b228c4-64718561',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_56e4b747bb66e2_07585804',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e4b747bb66e2_07585804')) {function content_56e4b747bb66e2_07585804($_smarty_tpl) {?><?php $_smarty_tpl->_capture_stack[0][] = array('tabs', null, null); ob_start(); ?>
    <li><a href="index.php?module=BlogAdmin">Блог</a></li>
    <?php if (in_array('articles',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?><li><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'ArticlesAdmin','id'=>null,'page'=>null),$_smarty_tpl);?>
">Статьи</a></li>
	<li class="active"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'ArticleCategoriesAdmin','id'=>null,'page'=>null),$_smarty_tpl);?>
...
<div class="message message_success">
    <span><?php if ($_smarty_tpl->tpl_vars['message_success']->value=='added') {?>Категория добавлена<?php } elseif ($_smarty_tpl->tpl_vars['message_success']->value=='updated') {?>Категория обновлена<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['message_success']->value;?>
<?php }?></span>
    <a class="link" target="_blank" href="../articles/<?php echo $_smarty_tpl->tpl_vars['category']->value->url;?>
...
<div class="message message_error">
    <span><?php if ($_smarty_tpl->tpl_vars['message_error']->value=='url_exists') {?>Категория с таким адресом уже существует<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['message_error']->value;?>
<?php }?></span>
...
foreach (Smarty::$global_tpl_vars as $key => $value) if(!isset($_smarty_tpl->tpl_vars[$key])) $_smarty_tpl->tpl_vars[$key] = $value;}}?>
    ...
    <div id="column_left">
        ...
        <div class="block layer">
            ...
            <ul>
                <li><label class=property>Адрес</label><div class="page_url">/articles/</div><input name="url" class="page_url" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->url, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
