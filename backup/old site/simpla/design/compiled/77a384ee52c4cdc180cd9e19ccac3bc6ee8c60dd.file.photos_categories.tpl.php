<?php /* Smarty version Smarty-3.1.18, created on 2016-03-09 06:48:56
         compiled from "simpla/design/html/photos_categories.tpl" */ ?>
<?php /*%%SmartyHeaderCode:24630018956dfab384bf181-50603608%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '77a384ee52c4cdc180cd9e19ccac3bc6ee8c60dd' => 
    array (
      0 => 'simpla/design/html/photos_categories.tpl',
      1 => 1429192126,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '24630018956dfab384bf181-50603608',
  'function' => 
  array (
    'categories_tree' => 
    array (
  ...
  'unifunc' => 'content_56dfab3852fde4_70412602',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56dfab3852fde4_70412602')) {function content_56dfab3852fde4_70412602($_smarty_tpl) {?>
...
<?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable('Фотоальбомы', null, 1);
if ($_smarty_tpl->parent != null) $_smarty_tpl->parent->tpl_vars['meta_title'] = clone $_smarty_tpl->tpl_vars['meta_title'];?>


<div id="header">
	<h1>Фотоальбомы</h1>
	<a class="add" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'PhotosCategoryAdmin','return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl);?>
">Добавить альбом</a>
</div>	
<!-- Заголовок (The End) -->
...
" />				
					...
					<div class="image cell">
						<?php if ($_smarty_tpl->tpl_vars['category']->value->image) {?>
							<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'PhotosCategoryAdmin','id'=>$_smarty_tpl->tpl_vars['category']->value->id,'return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl);?>
">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value->name, ENT_QUOTES, 'UTF-8', true);?>
					...
					<div class="icons cell">
						<a class="preview" title="Предпросмотр в новом окне" href="../photos/<?php echo $_smarty_tpl->tpl_vars['category']->value->url;?>
" target="_blank"></a>				
...
$(function() {
	...
	$("a.enable").click(function() {
		...
		$.ajax({
			...
			data: {'object': 'photos_category', 'id': id, 'values': {'visible': state}, 'session_id': '<?php echo $_SESSION['id'];?>
'},
