<?php /* Smarty version Smarty-3.1.18, created on 2016-03-09 20:43:06
         compiled from "simpla/design/html/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:134776754156e06eba8f57b5-07302551%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '134776754156e06eba8f57b5-07302551',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_56e06ebaa1ebc6_02645069',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e06ebaa1ebc6_02645069')) {function content_56e06ebaa1ebc6_02645069($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/ulafuacom/data/www/ulafua.com/Smarty/libs/plugins/modifier.replace.php';
...
">Игроки</a></li>
	<?php if (in_array('categories',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?><li><a href="index.php?module=CategoriesAdmin">Команды</a></li><?php }?>
...
<?php }?></span>
	...
	<a class="link" target="_blank" href="../players/<?php echo $_smarty_tpl->tpl_vars['product']->value->url;?>
...
/players/<?php echo urlencode($_smarty_tpl->tpl_vars['product']->value->url);?>
...
foreach (Smarty::$global_tpl_vars as $key => $value) if(!isset($_smarty_tpl->tpl_vars[$key])) $_smarty_tpl->tpl_vars[$key] = $value;}}?>
	...
	<div id="column_left">
		...
		<div class="block layer">
			...
			<ul>
				<li><label class=property>Адрес</label><div class="page_url"> /players/</div><input name="url" class="page_url" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->url, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
