<?php /* Smarty version Smarty-3.1.18, created on 2016-03-13 02:26:11
         compiled from "simpla/design/html/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:127155939256df68c577b511-10866186%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '127155939256df68c577b511-10866186',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_56df68c588ae79_10921762',
  'variables' => 
  array (
    'meta_title' => 0,
    'config' => 0,
...
<?php if ($_valid && !is_callable('content_56df68c588ae79_10921762')) {function content_56df68c588ae79_10921762($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<div id="main">
	...
	<?php if (in_array('products',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
		<li><a href="index.php?module=ProductsAdmin"><img src="design/images/menu/catalog.png"><b>Команды</b></a></li>
	<?php } elseif (in_array('categories',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
		<li><a href="index.php?module=CategoriesAdmin"><img src="design/images/menu/catalog.png"><b>Команды</b></a></li>
	<?php } elseif (in_array('brands',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
		<li><a href="index.php?module=BrandsAdmin"><img src="design/images/menu/catalog.png"><b>Команды</b></a></li>
	<?php } elseif (in_array('features',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
		<li><a href="index.php?module=FeaturesAdmin"><img src="design/images/menu/catalog.png"><b>Команды</b></a></li>
	<?php }?>
	...
	<?php } elseif (in_array('groups',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
		<li><a href="index.php?module=GroupsAdmin"><img src="design/images/menu/users.png"><b>Пользователи</b></a></li>
	<?php } elseif (in_array('coupons',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
		<li><a href="index.php?module=CouponsAdmin"><img src="design/images/menu/users.png"><b>Пользователи</b></a></li>
	<?php }?>
		
	<?php if (in_array('pages',$_smarty_tpl->tpl_vars['manager']->value->permissions)||in_array('photos',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
