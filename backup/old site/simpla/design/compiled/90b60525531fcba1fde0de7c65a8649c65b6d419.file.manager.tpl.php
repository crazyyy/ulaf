<?php /* Smarty version Smarty-3.1.18, created on 2016-03-13 02:23:01
         compiled from "simpla/design/html/manager.tpl" */ ?>
<?php /*%%SmartyHeaderCode:23942553356e4b2e59364c5-72915510%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '23942553356e4b2e59364c5-72915510',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e4b2e59df870_62457110',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e4b2e59df870_62457110')) {function content_56e4b2e59df870_62457110($_smarty_tpl) {?>
	...
	<div id="column_left">
		...
		<div class="block">
			<ul>
				...
				<?php $_smarty_tpl->tpl_vars['perms'] = new Smarty_variable(array('products'=>'Товары','categories'=>'Категории','brands'=>'Бренды','features'=>'Свойства товаров','orders'=>'Заказы','labels'=>'Метки заказов','users'=>'Покупатели','groups'=>'Группы покупателей','coupons'=>'Купоны','pages'=>'Страницы','blog'=>'Блог','articles'=>'Статьи','comments'=>'Комментарии','feedbacks'=>'Обратная связь','import'=>'Импорт','export'=>'Экспорт','backup'=>'Бекап','stats'=>'Статистика','design'=>'Дизайн','settings'=>'Настройки','currency'=>'Валюты','delivery'=>'Способы доставки','payment'=>'Способы оплаты','managers'=>'Менеджеры','license'=>'Управление лицензией','dmenus'=>'Управление независимым меню','photos'=>'Фотогалерея'), null, 0);?>
