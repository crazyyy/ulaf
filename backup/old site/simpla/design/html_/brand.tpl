...
{capture name=tabs}
	...
	<li class="active"><a href="index.php?module=BrandsAdmin">Спонсоры</a></li>
...
{else}
{$meta_title = 'Новый спонсор' scope=parent}
{/if}
...
<div class="message message_success">
	<span class="text">{if $message_success=='added'}Спонсор добавлен{elseif $message_success=='updated'}Спонсор обновлен{else}{$message_success}{/if}</span>
	<a class="link" target="_blank" href="../brands/{$brand->url}">Открыть спонсора на сайте</a>
