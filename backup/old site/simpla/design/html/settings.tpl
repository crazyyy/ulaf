...
<input type=hidden name="session_id" value="{$smarty.session.id}">
    ...
    <div class="block layer">
        ...
        <ul>
            <li><label class=property>Фотографий на странице сайта</label><input name="photos_num" class="simpla_inp" type="text" value="{$settings->photos_num|escape}" /></li>
            <li><label class=property>Фотографий на странице админки</label><input name="photos_num_admin" class="simpla_inp" type="text" value="{$settings->photos_num_admin|escape}" /></li>
        </ul>
    </div>
