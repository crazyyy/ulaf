...
{* Title *}
{$meta_title='Команды' scope=parent}

{* Заголовок *}
<div id="header">
	<h1>Команды</h1>
	<a class="add" href="{url module=CategoryAdmin return=$smarty.server.REQUEST_URI}">Добавить команду</a>
</div>	
<!-- Заголовок (The End) -->
			...
			<div class="{if !$category->visible}invisible{/if} row">		
				<div class="tree_row">
					...
					<div class="icons cell">
						<a class="preview" title="Предпросмотр в новом окне" href="../teams/{$category->url}" target="_blank"></a>				
