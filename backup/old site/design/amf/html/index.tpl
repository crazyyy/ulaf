...
<div class="outter-wrapper header-area header-style-2">
    ...
    <div class="wrapper clearfix">
        <header>
            ...
            <div class="main-header-left left"></div>


            <div class="main-header-right right"></div>
                            ...
                            {foreach $categories as $c}
                                ...
                                {if $c->visible}
                                    {if $c->image}
                                       ...
                                       <li><a href="catalog/{$c->url}"><img src="{$config->categories_images_dir}{$c->image}" alt="{$c->name|escape}" title="{$c->name|escape}"></a></li>
                                    {/if}
                                {/if}
...
<div class="outter-wrapper base-wrapper">
    <div class="wrapper clearfix">
        <div class="left">© Copyright Sport 2016</div>
