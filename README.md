...
- Craft Your Own Nginx with Brotli and QuicTLS in AaPanel https://hadezuka.dev/build-nginx-brotli-http3-quic-quictls-aapanel/
- How to add custom modules (brotli) to Nginx https://www.aapanel.com/blog/how-to-add-custom-modules-brotli-to-nginx/
- How to add custom modules for Nginx ( brotli ) https://www.aapanel.com/forum/d/2707-how-to-add-custom-modules-for-nginx-brotli
- How to Install the Brotli module for Nginx(on the aaPanel) https://www.nginxer.com/records/how-to-install-the-brotli-module-for-nginx-on-the-aapanel/
- How to install Brotli Module for Nginx on Ubuntu https://www.atlantic.net/dedicated-server-hosting/how-to-install-brotli-module-for-nginx-on-ubuntu/
- pagespeed https://nginx-extras.getpagespeed.com/modules/pagespeed/

- Awesome Nginx https://github.com/agile6v/awesome-nginx
- install nginx https://documentation.ubuntu.com/server/how-to/web-services/install-nginx/
- LUA Setting Nginx Lua Module https://nginxtutorials.com/nginx-lua-module/
- Nginx Modules https://nginxtutorials.com/nginx-modules/
- ⚙️ NGINX config generator on steroids 💉 https://github.com/digitalocean/nginxconfig.io    https://do.co/nginxconfig
- Nginx UI https://github.com/0xJacky/nginx-ui
- GoAccess is a real-time web log analyzer and interactive viewer https://github.com/allinurl/goaccess
